...
$data['ASSIGN_MASTER_TRANS_ADDITIONAL']='master_trans_additional_2'; // Assign Table Name for default master trans additional 

// master_trans_default assing for master trans table and part of Additional
$data['MASTER_TRANS_TABLE']='master_trans_table_2'; // Assign Table Name for default master trans table  ----------------------------
