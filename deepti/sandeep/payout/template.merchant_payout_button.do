...
<li class="dropdown phide" id="payout_button">
        ...
        <ul class="dropdown-display dropdown-menu dropdown_from_top" style="width:190px;position: absolute !important;inset: 0px auto auto 0px !important;">
          ...
          <li> <a class="dropdown-item" href="<?=$data['USER_FOLDER']?>/dashboard<?=$data['ex']?>" ><i class="<?=$payouticon2;?> text-primary fa-fw"></i> Payment Gateway</a> </li>
        <li> <a class="dropdown-item" href="<?=$data['USER_FOLDER']?>/summary<?=$data['ex']?>?act=1"><i class="<?=$payouticon1;?> text-primary fa-fw"></i> Payout Gateway</a> </li>
		
		<? /*?><li> <a class="dropdown-item" href="<?=$data['USER_FOLDER']?>/qr-code-dashboard<?=$data['ex']?>?act=1"><i class="<?=$payouticon3;?> text-primary fa-fw"></i> Qr Code Gateway</a> </li><? */?>
