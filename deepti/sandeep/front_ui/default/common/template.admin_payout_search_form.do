...
$divhide="";
$divcol="3";
if(($data['PageFile']=="payout-statement") ||($data['PageFile']=="statements") ){ $divhide="hide"; $divcol="5"; } 
?>
...
.search_form_css .col-sm-5 {width: 50% !important;max-width: 50% !important;}
  ...
  ?>
  <div class="col-sm-12 bg-primary border rounded mb-2 px-stmt" id="s_box">
...
<div class="col-sm-<?=$divcol;?> px-1 input-icons full_width" >
