...
<?if($data['Pages']){?><table class=frame width=100% border=0 cellspacing=1 cellpadding=4><tr><td class=capc><?$count=count($data['Pages']);for($i=0; $i<$count; $i++){?><?if($data['Pages'][$i]==$post['StartPage']){?><?=$i+1?><?}else{?><a href="shopcategories.do?action=<?=$post['action']?>&cid=<?=$post['cid']?>&page=<?=$data['Pages'][$i]?>"><?=$i+1?></a><?}?><?if($i<$count-1)echo(" | ");}?></td></tr></table><br><?}?>
...
<?foreach($data['CategoriesList'] as $key=>$value){$bgcolor=$key%2?'#EEEEEE':'#E7E7E7'?><tr bgcolor=<?=$bgcolor?> onmouseover="setPointer(this,<?=$key?>,'over','<?=$bgcolor?>','#CCFFCC','#FFCC99')" onmouseout="setPointer(this,<?=$key?>,'out','<?=$bgcolor?>','#CCFFCC','#FFCC99')" onmousedown="setPointer(this,<?=$key?>,'click','<?=$bgcolor?>','#CCFFCC','#FFCC99')"><td align=right valign=top><a href="shopcategories.do?cid=<?=$value['id']?>&action=view"><?=$value['name']?></a></td><td valign=top align=center>(<?=($value['subcategories'])?>)</td><td valign=top align=center>(<?=($value['items'])?>)</td><td valign=top><?=$value['description']?></td>
<td align=center valign=top nowrap><a href="shopcategories.do?cid=<?=$value['id']?>&action=view">VIEW</a>|<a href="shopcategories.do?cid=<?=$value['id']?>&action=viewitems">ITEMS</a>|<a href="shopcategories.do?updateid=<?=$value['id']?>&cid=<?=$post['cid']?>&action=update&page=<?=$post['StartPage']?>">EDIT</a>
<?if($value['candelete']){?><br><a href="shopcategories.do?updateid=<?=$value['id']?>&cid=<?=$post['cid']?>&action=delete&page=<?=$post['StartPage']?>" onclick="return cfmform()">DELETE</a><?}?></td></tr><?}?></table>
...
<?if($data['Pages']){?><br><table class=frame width=100% border=0 cellspacing=1 cellpadding=4><tr><td class=capc><?$count=count($data['Pages']);for($i=0; $i<$count; $i++){?><?if($data['Pages'][$i]==$post['StartPage']){?><?=$i+1?><?}else{?><a href="shopcategories.do?action=<?=$post['action']?>&cid=<?=$post['cid']?>&page=<?=$data['Pages'][$i]?>"><?=$i+1?></a><?}?><?if($i<$count-1)echo(" | ");}?></td></tr></table><?}?>
...
<td align=center valign=top nowrap><a href="shopcategories.do?updateid=<?=$value['id']?>&cid=<?=$post['cid']?>&action=updateitem&page=<?=$post['StartPage']?>">EDIT</a><?if($value['candelete']){?><br><a href="shopcategories.do?itemid=<?=$value['id']?>&cid=<?=$post['cid']?>&action=deleteitem&page=<?=$post['StartPage']?>" onclick="return cfmform()">DELETE</a><?}?></td></tr><?}?></table>
...
<?foreach($data['CategoriesList'] as $key=>$value){$bgcolor=$key%2?'#EEEEEE':'#E7E7E7'?><tr bgcolor=<?=$bgcolor?> onmouseover="setPointer(this,<?=$key?>,'over','<?=$bgcolor?>','#CCFFCC','#FFCC99')" onmouseout="setPointer(this,<?=$key?>,'out','<?=$bgcolor?>','#CCFFCC','#FFCC99')" onmousedown="setPointer(this,<?=$key?>,'click','<?=$bgcolor?>','#CCFFCC','#FFCC99')"><td align=right valign=top><a href="shopcategories.do?cid=<?=$value['id']?>&action=view"><?=$value['name']?></a></td><td valign=top align=center>(<?=($value['subcategories'])?>)</td><td valign=top align=center>(<?=($value['items'])?>)</td><td valign=top><?=$value['description']?></td>
<td align=center valign=top nowrap><a href="shopcategories.do?cid=<?=$value['id']?>&action=view">GO TO</a>|<a href="shopcategories.do?cid=<?=$value['id']?>&action=viewitems">ITEMS</a></td></tr><?}?></table>
...
<?foreach($data['ItemsList'] as $key=>$value){$bgcolor=$key%2?'#EEEEEE':'#E7E7E7'?><tr bgcolor=<?=$bgcolor?> onmouseover="setPointer(this,<?=$key?>,'over','<?=$bgcolor?>','#CCFFCC','#FFCC99')" onmouseout="setPointer(this,<?=$key?>,'out','<?=$bgcolor?>','#CCFFCC','#FFCC99')" onmousedown="setPointer(this,<?=$key?>,'click','<?=$bgcolor?>','#CCFFCC','#FFCC99')"><td align=right valign=top><?=$value['name']?></td><td valign=top><a href='<?=$value['url']?>' target='_blank'><?=$value['url']?></a></td><td valign=top><?=$value['description']?></td>
<td align=center valign=top nowrap><a href="shopcategories.do?cid=<?=$value['categoryid']?>&action=viewitems">GO TO</a></td></tr><?}?></table>
