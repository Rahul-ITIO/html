...
<div class="switcher-box">
  <?php /*?><div class="hiddenbox light-backg border" title="Adjust Font Sizing" data-bs-toggle="tooltip" data-bs-placement="left"><i class="<?=$data['fwicon']['a'];?>"></i></div>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light5 bg-primary text-white">
  <div class="container">
   ...
   ?>
        ...
        <li class="nav-item"> <a class="nav-link text-white menu-summary" href="<?=$data['Members']?>/<?=$data['MYWEBSITEURL']?><?=$data['ex']?>"><?=$data['MYWEBSITE']?></a> </li>
        <? } ?>
        <li class="nav-item dropdown"> <a class="nav-link text-white dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Transactions </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/<?=$data['trnslist'];?><?=$data['ex']?>">All Transaction</a></li>
            <? } ?>
            <? if(((in_array(4, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
            <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/block_<?=$data['trnslist'];?><?=$data['ex']?>">Block Transaction</a></li>
            <? } ?>
            <? if(((in_array(15, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
            <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/test_<?=$data['trnslist'];?><?=$data['ex']?>">Test Transaction</a></li>
            <? } ?>
            <? if(((in_array(10, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
            <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/<?=$data['trnslist'];?>_recent_order<?=$data['ex']?>">Recent Order</a></li>
            <? } ?>
            <li>
              <hr class="dropdown-divider">
            </li>
            <? if(((in_array(14, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
            <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/trans_statement<?=$data['ex']?>">Statement</a></li>
            <? } ?>
            <? if(((in_array(16, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
            <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/trans_withdraw-fund-list<?=$data['ex']?>">Withdraw Fund</a></li>
            <? } ?>
          </ul>
        </li>
        <? } ?>
...
?>
    ...
    <li class="nav-item dropdown"> <a class="nav-link text-white dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"  title="Templates"> <i class="<?=$data['fwicon']['transaction'];?> fa-fw"></i> <span class="menu_title">Transactions</span> </a>
      <ul class="dropdown-menu text-white" aria-labelledby="navbarDropdown" style="">
        <? if(((in_array(3, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        <li><a  class="dropdown-item menu-summary" href="<?=$data['Members']?>/<?=$data['trnslist'];?><?=$data['ex']?>">&nbsp;&nbsp;<i class="<?=$data['fwicon']['transaction'];?> fa-fw"></i>&nbsp;All Transaction</a></li>
        <? } ?>
        <? if(((in_array(4, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        <li><a  class="dropdown-item menu-summary" href="<?=$data['Members']?>/block_<?=$data['trnslist'];?><?=$data['ex']?>">&nbsp;&nbsp;<i class="<?=$data['fwicon']['blocktransaction'];?> fa-fw"></i>&nbsp;Block Transaction</a></li>
        <? } ?>
        <? if(((in_array(15, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        <li><a  class="dropdown-item menu-summary" href="<?=$data['Members']?>/test_<?=$data['trnslist'];?><?=$data['ex']?>">&nbsp;&nbsp;<i class="<?=$data['fwicon']['testtransaction'];?> fa-fw"></i>&nbsp;Test Transaction</a></li>
        <? } ?>
        <? if(((in_array(10, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        ...
        <? } ?>
        <? if(((in_array(14, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        <li><a  class="dropdown-item menu-summary" href="<?=$data['Members']?>/trans_statement<?=$data['ex']?>">&nbsp;&nbsp;<i class="<?=$data['fwicon']['mystatement'];?> fa-fw"></i>&nbsp;My Statement</a></li>
        <? } ?>
        <? if(((in_array(11, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        <li><a class="dropdown-item menu-summary" href="<?=$data['Members']?>/request_fund<?=$data['ex']?>">&nbsp;&nbsp;<i class="<?=$data['fwicon']['requestfund'];?> fa-fw"></i>&nbsp;Request Funds
          <?php /*?><?=$post['default_currency_sys'];?><?php */?>
          </a></li>
        <? } ?>
        <? if(((in_array(16, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
        <li><a  class="dropdown-item menu-summary" href="<?=$data['Members']?>/trans_withdraw-fund-list<?=$data['ex']?>">&nbsp;&nbsp;<i class="<?=$data['fwicon']['settlement'];?> fa-fw"></i>&nbsp;Withdrawal Funds
          <?php /*?> <?=$post['default_currency_sys'];?><?php */?>
          </a></li>
        <? } ?>
      </ul>
    ...
    <? if(((in_array(8, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
    <li><a class="text-white text-decoration-none menu-summary" href="<?=$data['Members']?>/<?=$data['MYWEBSITEURL']?><?=$data['ex']?>" title="My <?=$data['MYWEBSITE']?>"><i class="<?=$data['fwicon']['website'];?> fa-fw"></i><span class="menu_title">&nbsp;My <?=$data['MYWEBSITE']?></span></a></li>
    <? } ?>
    <? if(((in_array(7, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
    <li><a class="text-white text-decoration-none menu-summary" href="<?=$data['Members']?>/bank<?=$data['ex']?>" title="My Bank Accounts"><i class="<?=$data['fwicon']['bank'];?> fa-fw"></i><span class="menu_title">&nbsp;My Bank Accounts</span></a></li>
    <? } ?>
    <? if(((in_array(14, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
    <li><a  class="text-white text-decoration-none menu-summary" href="<?=$data['Members']?>/stats<?=$data['ex']?>" title="Success Ratio"><i class="<?=$data['fwicon']['chart'];?> fa-fw"></i><span class="menu_title">&nbsp;Success Ratio</span></a></li>
    <? } ?>
    <? if(((in_array(5, $grole)) && ($_SESSION['m_member_type']=='Sub Member')) || ($_SESSION['m_member_type']=='')){ ?>
    <li><a class="text-white text-decoration-none menu-summary" href="<?=$data['Members']?>/manage-user<?=$data['ex']?>" title="User Management"><i class="<?=$data['fwicon']['manage-user'];?> fa-fw"></i><span class="menu_title">&nbsp;User Management</span></a></li>
    <? } ?>
    <? } ?>
  </ul>
</nav>
...
$header_title_search = array("processall", "test3dsecureauthentication", "success", "failed", "developer", "docs", "transaction_processing", "device_confirmations", "forgot", "login", "logout", "signup", "password","confirm","two-factor-authentication","bank","chart","payin-processing-engine","return_url","trans_processing");
