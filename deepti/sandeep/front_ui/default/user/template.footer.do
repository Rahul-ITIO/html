...
<footer class="footer mt-auto">
  <div class="container-flex">
	...
	<div class="b-example-divider text-center" style="padding-top:12px;">
	<? if(isset($_SESSION['subadmin_customer_service_no'])&&$_SESSION['subadmin_customer_service_no']){ ?>
	<a href="tel:<?=$_SESSION['subadmin_customer_service_no'];?>" class="mx-2 text-white" title="Customer Service No."><i class="<?=$data['fwicon']['headphones'];?>"></i> <?=$_SESSION['subadmin_customer_service_no'];?></a> <? } ?>
	<? if(isset($_SESSION['subadmin_customer_service_email'])&&$_SESSION['subadmin_customer_service_email']){ ?>
	<a target='_blank' title="Customer Service Email" href="mailto:<?=encrypts_decrypts_emails($_SESSION['subadmin_customer_service_email'],2);?>?subject=I need help&body=Dear <?=$data['SiteName'];?>, I need your help about ..." class="mx-2 text-white" ><i class="<?=$data['fwicon']['email'];?>"></i> <?=encrypts_decrypts_emails($_SESSION['subadmin_customer_service_email'],2);?></a>
	<? } ?>
...
<div class="modalpopup_processing hide" id="modalpopup_processing_full_layer">
