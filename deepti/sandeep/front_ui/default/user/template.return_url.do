...
.box-width{width: auto !important;}
	...
	<div class="containerMain border rounded text-center rounded-tringle mt-5 box-width" style="max-width:500px; margin:0 auto;">
		...
		<div class="text-muted my-2 fs-6 fw-bold text-secondary-emphasis"> <?=date("l jS \of F Y h:i:s A", strtotime($getresponse['tdate']));?> <i class="<?=@$data['fwicon']['clock'];?>"></i></div>
