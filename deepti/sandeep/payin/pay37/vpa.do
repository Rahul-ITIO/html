<?php 
		...
		$apiUrl	= "https://indusapiuat.indusind.com/indusapi-np/uat/eph-upi/CheckVPA/v2";
...
/*		$client_id		= "764d7dd1ed959c7f5735f294aae9750f";
		...
		$apiUrl			= "https://indusapi.indusind.com/indusapi/prod/iec/etender/getTenderId/v1";
...
*/
	...
	$ts = date('Y-m-d H:i:s', strtotime("+4 hours +30 minutes"));
	$ts = str_replace(' ', 'T',$ts);
	$ts = $ts.'Z';
