...
<style>
body {padding:10px 10px 300px 30px;margin:10px 10px 400px 10px;overflow: hidden;
    overflow-y: auto;}
.container {
    width: 90%;
    margin-left: 5%;
   ...
   <body >
      ...
      <div class="container">
		...
		<div class="row">
          <div class="col-md-4 col-md-offset-2 demo">
            <h4>Custome Date Range Picker</h4>
            <center>
              <input type="text" id="date_range_99" class="form-control" style="width:250px">
            </center>
          </div>
		</div>
      ...
      $(document).ready(function() {
			...
			//var start = moment().subtract(29, 'days'); // Last 30 Days Default
			var start_de = moment().subtract(6, 'days'); // Last 7 Days Default
			var end_de = moment();
				
			//Yesterday 
			var start_de = moment().subtract(1, 'days'); // Last 7 Days Default
			var end_de = moment().subtract(1, 'days');
			
			
			//Yesterday 
			var start_de = moment('2023-08-13 00:00:00'); // Last 7 3 Days Default
			var end_de = moment('2023-08-19 23:59:59');
					
			// https://momentjs.com/guides/#/warnings/js-date/
			
			$('#date_range_99').daterangepicker({
				"showDropdowns": true,
				"timePicker": true,
				...
				ranges: {
					'Today': [moment("<?=date('Y-m-d 00:00:00')?>"), moment("<?=date('Y-m-d 23:59:59')?>")],
					'Yesterday': [moment().subtract(1, 'days'), moment().subtract(1, 'days')],
					'Last 7 Days': [moment().subtract(6, 'days'), moment()],
					//'Last 7 Days with Time': [moment('2023-08-19 00:00:00').subtract(6, 'days'), moment('2023-08-19 23:59:59')],
					'Last 7 Days 3': [moment('2023-08-13 00:00:00'), moment('2023-08-19 23:59:59')],
					//'Last 7 Days': [moment('2016-03-12 00:00:00').subtract(6, 'days'), moment('2016-03-12 23:59:59')],
...
<h3>Date Range Picker With Times</h3>
...
<h3>Simple Date Range Picker With a Callback </h3>
