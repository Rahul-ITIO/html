...
$(document).ready(function(){
    ...
    <div class="row text-center my-2 float-end me-2">
	  <a href="<?=$data['Admins'];?>/<?=$data['PageFile'];?><?=$data['ex']?>?action=payout_request"  class="nopopup btn btn-primary" onclick="return confirm('Are you Sure to Payout Request!')" target="_blank" title="Payout Request"><i class="<?=$data['fwicon']['circle-plus'];?>"></i> </a>
	  </div>
