...
<h4 class="my-2"><i class="<?=$data['fwicon']['book'];?>"></i> Glossary - A collection of textual glosses with their meanings or definition.</h4>

<div class="container table-responsive">
  <?php /*?>Function Defined from /config_db.do <?php */?>
  <span class="badge rounded-pill bg-vdark"> Filename: <strong>/Config DB </strong></span>
  <table class="table table-hover">
    <thead>
      <tr>
        <th scope="col">Function Name</th>
        <th scope="col">Default Values (if defined)</th>
    ...
    <tbody>
      ...
      <tr>
        <td>calculation_tr_fee($trange, $uids=0, $all=false, $pdate='', $cpost='')</td>
        <td>$uids=0<br />
          $all=false<br />
          $pdate=''<br />
          $cpost=''</td>
      ...
      <tr>
        <td>max_settelement_period($uid=0, $cdate='')</td>
        <td>$uid=0<br />
          $cdate=''</td>
        <td>Fetch maximum settlement days</td>
      </tr>
      <tr>
        <td>withdraw_max_prev($uid=0, $tid=0, $clk_status=0)</td>
        <td>$uid=0<br />
          $tid=0<br />
          $clk_status=0</td>
      ...
      <tr>
        <td>m_bal_update_1($uid=0, $tid=0, $tdate=0)</td>
        <td>$uid=0<br />
          $tid=0<br />
          $tdate=0</td>
        <td>No any use</td>
      ...
      <tr>
        <td>m_bal_update_all()</td>
        <td>&nbsp;</td>
        <td>Update balance upto date.</td>
      </tr>
      <tr>
        <td>m_bal_update($uid=0, $tid=0, $tdate=0)</td>
        <td>$uid=0<br />
          $tid=0<br />
          $tdate=0</td>
      ...
      <tr>
        <td>select_products($uid, $type=0, $id=0, $single=false, $active=0, $where_pred='')</td>
        <td>$type=0 <br />
          $id=0 <br />
          $single=false <br />
          $active=0 <br />
      ...
      <tr>
        <td>json_value_tr($postArray='', $getArray='', $skip=0)</td>
        <td>$postArray='' <br />
          $getArray='' <br />
          $skip=0</td>
      ...
      <tr>
        <td>transactions_updates($id, $post='', $skip=0)</td>
        <td>$post='' <br />
          $skip=0</td>
      ...
      <tr>
        <td>encode64f($sData, $sKey='MY_SECRET_ANQtkR7ak8RZ')</td>
        <td>$sKey='MY_SECRET_ANQtkR7ak8RZ'</td>
        <td>No any use</td>
      </tr>
      <tr>
        <td>decode64f($sData, $sKey='MY_SECRET_ANQtkR7ak8RZ')</td>
        <td>$sKey='MY_SECRET_ANQtkR7ak8RZ'</td>
        <td>No any use</td>
      </tr>
      <tr>
...
<div class="container table-responsive-sm">
  <?php /*?>Function Defined from /function_raj.do <?php */?>
  <span class="badge rounded-pill bg-vdark"> Filename: <strong>/Function Raj </strong></span>
  <table class="table table-hover">
    <thead>
      <tr>
        <th scope="col">Function Name</th>
    ...
    <tbody>
      ...
      <tr>
        <td class="fw-bold-11">fetch_account_info($memId)</td>
        <td>&nbsp;</td>
        <td>The fetch_account_info() function is used to fetch all the account details of a clients or all clients.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">fetch_balance($memId="", $json_frozen=0)</td>
        <td>&nbsp;</td>
        <td>The fetch_balance() is used for fetch all transaction details of a clients or all transactions.</td>
      </tr>
      <tr>
        <td class="fw-bold-11">account_balance_newac($uid=0, $tr_id=0, $currentDate='', $trans_detail_array=[])</td>
        <td>&nbsp;</td>
        <td>The account_balance_newac() used to calculate all type of balance and total records.</td>
      </tr>
      <tr>
        <td class="fw-bold-11">payout_trans_new($uid=0, $type=2)</td>
        <td>&nbsp;</td>
        <td>The payout_trans_new() used to calculate payout settlement balance and period</td>
      </tr>
      <tr>
        <td class="fw-bold-11">account_trans_balance_calc_new($uid=0, $trans_detail_array=[], $currentDate='', $tr_id=0)</td>
        <td>&nbsp;</td>
        <td>The function account_trans_balance_calc_new() used to manage the complete ledger of a clients.</td>
      </tr>
      <tr>
        <td class="fw-bold-11">account_trans_balance_calc_d_new($uid=0, $currentDate='', $tr_id=0, $trans_detail_array=[])</td>
        <td>&nbsp;</td>
        <td>The function account_trans_balance_calc_d_new() used to manage the complete ledger of a clients.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">get_transactions_2($uid, $dir='both', $type=-1, $status=-1, $start=0, $count=0, $order='', $suser='', $sdate='')</td>
        <td>&nbsp;</td>
        <td>The get_transactions_2() used to fetch list of transactions for merchant section.</td>
      </tr>
      <tr>
        <td class="fw-bold-11">get_transactions_list($uid, $dir='both', $type=-1, $status=-1, $start=0, $count=0, $order='', $sort = 'DESC', $suser='', $sdate='')</td>
        <td>&nbsp;</td>
        <td>The get_transactions_list() used to fetch list of transactions for admin section.</td>
      </tr>
      <tr>
...
<div class="container table-responsive-sm">
  <?php /*?>Function Defined from /common.do <?php */?>
  <span class="badge rounded-pill bg-vdark"> Filename: <strong>/Common </strong></span>
  <table class="table table-hover">
    <thead>
      <tr>
        <th scope="col">Function Name</th>
    ...
    <tbody>
      ...
      <tr>
        <td class="fw-bold-11">create_graphf($post, $param=0)</td>
        <td>&nbsp;</td>
        <td>The function create_graphf() is used to display all the transaction details in graphic format of a merchant.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">get_transaction_count_where_pred($where_pred)</td>
        <td>&nbsp;</td>
        <td>The get_transaction_count_where_pred() used to retrive total transactions via defined condition</td>
      </tr>
	  <tr>
      ...
      <tr>
        <td class="fw-bold-11">set_trtype($uid, $dir, $as='')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">get_transaction_detail_table($trans_id, $uid)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">insert_product($uid, $type, $post, $admin=false)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">update_product($id, $post, $admin=false)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">update_status($id, $where_pred)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">update_status_bank($id, $where_pred, $tab="banks")</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">update_sold($id, $quantity)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">api_token_store($uid, $id)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">delete_product($id)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">select_account($uid, $id=0, $single=false, $account_type='')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">insert_account_info($post, $uid, $notify=true)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">update_account_info($post, $gid, $uid, $notify=true)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">delete_account($gid)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">scrubbed($uid, $account_type, $trans_id='', $email='')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">update_transaction_ranges($uid, $status, $trange='', $paydate='',  $update_tr=true,  $adm_login=true, $json_value='')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">unique_id_tr($trid)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">insert_transaction($sender, $receiver, $related, $amount, $fees, $type, $status, $comments='', $ecomments='', $names='', $address='', $city='', $state='', $zip='', $email='', $ccno='', $billphone='', $product_name='', $source_url='')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">get_trans_counts($where='')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">trans_reply_counts($uid=0, $reply_status=0)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">get_transactions_count($uid, $dir='both', $extra='1')</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">get_transaction_detail($id, $uid)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">virtual_fee($uid)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="fw-bold-11">getstoreid($mid, $ajax)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
        <td class="fw-bold-11">getacquirerids($wid, $ajax)</td>
        <td>&nbsp;</td>
        <td>xxxxx</td>
      </tr>
      <tr>
