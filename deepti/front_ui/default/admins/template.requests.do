...
$(document).ready(function(){
  ...
  <form method="post" name="data" >
   ...
   <span id="apic" class="hide"><?=urldecode($convert_qrcode_from_url);?></span>
	  ...
	  <a title="Your QR code"  href="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?=$convert_qrcode_from_url;?>&choe=UTF-8" class="btn btn-primary my-rpnsive-btn my-2 ms-2 float-end modal_from_url_qrcode" copyid="apic" style="width:40px;"><i class="<?=$data['fwicon']['qrcode'];?>"></i></a>
...
<span id="apic<?=$j;?>" class="hide"><?=urldecode($convert_qrcode_list);?></span>
			<a title="Your QR code"  href="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?=$convert_qrcode_list;?>&choe=UTF-8" class=" modal_from_url_qrcode" copyid="apic<?=$j;?>" style="width:40px;"><i class="<?=$data['fwicon']['qrcode'];?>"></i></a>
            <? } ?>
          </td>
        </tr>
        <tr class="hide">
