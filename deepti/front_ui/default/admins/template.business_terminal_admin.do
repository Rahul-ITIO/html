...
?>
  ...
  <? if($post['Terminals']){ ?>
    ...
    <tr>
      ...
      <td><? if($value['public_key']<>""){ ?><a data-href="<?=($value['public_key'])?>" title="Copy Public Key - <?=($value['public_key'])?>" id="apic_<?=$k;?>"><i class="<?=$data['fwicon']['copy'];?>" onclick="ctcf('#apic_<?=$k;?>','data-href')"></i> </a><? } ?></td>
