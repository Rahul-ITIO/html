...
?>
  ...
  ?>
                    ...
                    <? }else{?>
						<? if($value['typenum']>4  ){?>
							<?/*?>
						<li class='g_validate 14'><a data-mhoid="<?=$value['transID'];?>_<?=@$value['id'];?>" data-type="<?=$value['typenum'];?>" onClick="hkipstatus(this);"  ><i class="<?=$data['fwicon']['retweet'];?>"></i>
						  <?=@$data['acquirer_name'][$value['typenum']];?>
						  Status</a></li>
						  <?*/?>
						  <?
