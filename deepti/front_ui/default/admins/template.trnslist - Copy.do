...
<div class="alert alert-success alert-dismissible fade show my-2" role="alert">
  <strong>Success !</strong> <?=prntext($_SESSION['action_success']);?>.
                        ...
                        <div id="transaction_display_divid" class="hide" style="float:right;right:0;">
                          <select id="transaction_display" data-placeholder="Transaction Display Option" title="Transaction Display Option" multiple class="chosen-select chosen-rtl1 form-select" name="transaction_display[]">
                           <? if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transID'])&&$_SESSION['tr_transID']==1)){?>
							...
							<? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_action'])&&$_SESSION['tr_action']==1)){?>
                            <option value="action" data-placeholder="Action" title="Action">Action</option>
							<? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['bearer_token'])&&$_SESSION['bearer_token']==1)){?>
                            <option value="bearer_token" data-placeholder="Bearer Token" title="Bearer Token">Bearer Token</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_fullname'])&&$_SESSION['tr_fullname']==1)){?>
                            <option value="fullname" data-holder="FullName" title="FullName">FullName</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_amount'])&&$_SESSION['tr_amount']==1)){?>
                            <option value="amount" data-holder="Bill Amt" title="Bill Amt">Bill Amt</option>
                            ...
                            <option value="available_balance" data-holder="Available Balance" title="Available Balance">Available Balance</option>
                            ...
                            <option value="mop" data-holder="Visa;MasterCard" title="Visa,MasterCard">MOP</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_reason'])&&$_SESSION['tr_reason']==1)){?>
                            <option value="reason" data-holder="Trans Response" title="Trans Response">Trans Response</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_type'])&&$_SESSION['tr_type']==1)){?>
                            <option value="type" data-holder="Acquirer" title="Acquirer: 16;18:19;27;">Acquirer</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_status'])&&$_SESSION['tr_status']==1)){?>
                            <option value="status" data-holder="Trans Status" title="Trans Status: 0;1;2;">Trans Status</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_merID'])&&$_SESSION['tr_merID']==1)){?>
                            <option value="merID" data-holder="Username" title="Username">Username</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_acquirer_response'])&&$_SESSION['tr_acquirer_response']==1)){?>
                            <option value="acquirer_response" data-holder="Acquirer Response" title="Acquirer Response">Acquirer Response</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_json_value'])&&$_SESSION['tr_json_value']==1)){?>
                            <option value="json_value" data-holder="Json Value" title="Json Value">Json Value</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_currname'])&&$_SESSION['tr_currname']==1)){?>
                            <option value="bill_currency" data-holder="Bill Currency" title="Bill Currency">Bill Currency</option>
                            ...
                            <option value="support_note" title="Note Support">Support Note</option>
                            ...
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transID'])&&$_SESSION['tr_transID']==1)){?>
                            <option value="transID" title="TransID">TransID</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_system_note'])&&$_SESSION['tr_system_note']==1)){?>
                            <option value="system_note" title="System Note">System Note</option>
                            ...
                            <option value="mdr_cbk1_amt" title="Predispute Fee">MDR cbk1 Amt</option>
                            ...
                            <option value="settelement_date" title="Settelement Date">Settelement Date</option>
                            ...
                            <option value="trans_type" data-holder="wd;wr;dp;cn;ch" title="wd;wr;dp;cn;ch">Trans Type</option>
                            ...
                            <option value="bill_address" data-holder="Address" title="Address">Bill Address</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_city'])&&$_SESSION['tr_city']==1)){?>
                            <option value="bill_city" data-holder="Bill City" title="Bill City">Bill City</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_state'])&&$_SESSION['tr_state']==1)){?>
                            <option value="bill_state" data-holder="Bill State" title="Bill State">Bill State</option>
                            <? }if((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_country'])&&$_SESSION['tr_country']==1)){?>
                            <option value="country" data-holder="Bill Country" title="Bill Country">Bill Country</option>
                            ...
                            <option value="bill_ip" data-holder="Bill IP" title="Bill IP">Bill IP</option>
...
?>
          ...
          <table id="content22"  class="table table-striped" >  <!-- Resizable Table Columns With Drag and Slide & drag table Columns -->
              <thead>
                <tr class="text-start bg-dark-subtle">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("transID",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transID'])&&$_SESSION['tr_transID']==1))){?>
				  ...
				  <? if((isset($_SESSION['login_adm']))||(isset($_SESSION['t_multiple_check_box'])&&$_SESSION['t_multiple_check_box']==1)){  ?>
                    ...
                    <? }?>
					<span class="hide">echeckid</span>
				  </th>
				  
				  <th class="capc" scope="col" data-type="text-short" valign="top">
				  ...
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("reference",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mrid'])&&$_SESSION['tr_mrid']==1))){?>
				  <div class="transaction-h2">
					<a title="Merchant Order Id" data-bs-toggle="tooltip" data-bs-placement="top" href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=reference" class="text-link">Reference</a> 
				  </div>
				 <? }?>
				  ...
				  <th class="capc" scope="col"  title="Action" data-bs-toggle="tooltip" data-bs-placement="top" valign="top">
				  ...
				  <span class="hide">action</span>
                  <? }?>
                  </th>
				  
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bearer_token",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mrid'])&&$_SESSION['tr_bearer_token']==1))){?>
                  <th class="capc" scope="col"  valign="top"><a title="Bearer Token" data-bs-toggle="tooltip" data-bs-placement="top" href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=bearer_token" class="text-link">
				   <div class="transaction-h1">Json&nbsp;Log</div>
				   <div class="transaction-h2">B.Token</div>
				  </a></th>
                  <? }?>
                  
                  <th class="capc" scope="col"  valign="top">
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("fullname",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_fullname'])&&$_SESSION['tr_fullname']==1))){?>
				  <div class="transaction-h1"><a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=fullname" class="text-link" title="FullName" >FullName</a> </div>
				  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_email",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_bill_email'])&&$_SESSION['tr_bill_email']==1))){?>
				  <div class="transaction-h2">Bill&nbsp;Email</div>
				  <? } ?>
				  </th>
                  
                 
                  <th class="capc" scope="col"  valign="top">
				   <? if(isset($_SESSION['transaction_display_arr'])&&in_array("amount",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_amount'])&&$_SESSION['tr_amount']==1))){?>
				  <div class="transaction-h1">
				  <a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=bill_amt" class="text-link" title="Order Amount" >Bill&nbsp;Amt</a>
				  </div>
				  <? }?>
				  
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("trans_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transaction_amt'])&&$_SESSION['tr_transaction_amt']==1))){?>
				  <div class="transaction-h2">
				  <a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=trans_amt" class="text-link" title="Transaction Amount" >Trans&nbsp;Amt</a>
				  </div>
				  <? }?>
				  </th>
                  ...
                  <th class="capc" scope="col"  valign="top"> 
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("available_balance",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_available_balance'])&&$_SESSION['tr_available_balance']==1))){?>
				  <div class="transaction-h1">
				  <a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=available_balance" title="Balance Amount" class="text-link">Available&nbsp;Balance</a>
				  </div>
				  <? }?>
				  </th>
                  ...
                  <th class="capc" scope="col"  valign="top">
				  <?  if(isset($_SESSION['transaction_display_arr'])&&in_array("tdate",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_tdate'])&&$_SESSION['tr_tdate']==1))){?>
				  <div class="transaction-h1">
				  <a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?><? if(isset($post['type']) && $post['type']){?>type=<?=$post['type']?><? } ?>&status=<?=$post['status']?>&action=select&order=tdate" title="Transaction Date Time" >Timestamp </a>
				  </div>
				  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("created_date",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_created_date'])&&$_SESSION['tr_created_date']==1))){?>
                  <div class="transaction-h2">Created&nbsp;Date</div>
                  <? }?>
				  
				  </th>
                  <th class="capc" scope="col"  valign="top" >
                   <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mop",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mop'])&&$_SESSION['tr_mop']==1))){?>
                  <div class="transaction-h1">MOP</div>
                  <? }?>
				 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("type",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_type'])&&$_SESSION['tr_type']==1))){?>
                  <? if((isset($_SESSION['login_adm']))||(isset($_SESSION['t_acquirer_view'])&&$_SESSION['t_acquirer_view']==1)){?>
                  <? if($post['acquirer']<0){?>
				  <div class="transaction-h2">
                  <a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=acquirer" class="text-link">Acquirer</a>
				  </div>
                  <? }?>
                  <? }?>
                  <? }?>
                 ...
                 <th class="capc" scope="col"  class="text-start" valign="top">
                 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("status",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_status'])&&$_SESSION['tr_status']==1))){?>
                  <? if($post['status']<0){?>
				  <div class="transaction-h1">
                  <a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=trans_status" class="text-link">Trans&nbsp;Status</a>
				  </div>
                  <? }?>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("reason",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_reason'])&&$_SESSION['tr_reason']==1))){?>
                  <div class="transaction-h2">Trans Response</div>
                  <? }?>
				  
				  </th>
				  <th class="capc" scope="col"  valign="top">
                 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("merID",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_merID'])&&$_SESSION['tr_merID']==1))){?>
				  <div class="transaction-h1">
				  <a href="<?=$data['Admins']?>/<?=$data['trnslist'];?><?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['acquirer']?>&status=<?=$post['status']?>&action=select&order=merID" class="text-link">Username</a>
				  </div>
                  <? }?>
                 </th>
				  
				  <th class="capc" scope="col" valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("ccno",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_ccno'])&&$_SESSION['tr_ccno']==1))){?>
                  <div class="transaction-h1">CCNo</div>
				   <? }?>
				 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("upa",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_upa'])&&$_SESSION['tr_upa']==1))){?>
				  ...
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_ip",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_ip'])&&$_SESSION['tr_ip']==1))){?>
                  <div class="transaction-h1">Bill&nbsp;IP</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("terNO",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_terNO'])&&$_SESSION['tr_terNO']==1))){?>
                  <div class="transaction-h2">TerNO</div>
                  <? }?>
				  </th>
<th class="capc" scope="col"  title="Ref No. of Bank Response"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("acquirer_ref",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_txn_id'])&&$_SESSION['tr_txn_id']==1))){?>
                  <div class="transaction-h1">Acquirer&nbsp;Ref</div>
                  <? }?>
				  </th>
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("acquirer_response",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_acquirer_response'])&&$_SESSION['tr_acquirer_response']==1))){?>
                  <div class="transaction-h1">Acquirer&nbsp;Response</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("json_value",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_json_value'])&&$_SESSION['tr_json_value']==1))){?>
                  <div class="transaction-h2">Json&nbsp;Value</div>
                  <? }?>
				  </th>
                 
                  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("support_note",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_support_note'])&&$_SESSION['tr_support_note']==1))){?>
                  <div class="transaction-h1">Support&nbsp;Note</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("system_note",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_system_note'])&&$_SESSION['tr_system_note']==1))){?>
                  <div class="transaction-h2">System&nbsp;Note</div>
                  <? }?>
				  
				  </th>
                <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("source_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_source_url'])&&$_SESSION['tr_source_url']==1))){?>
                  <div class="transaction-h1">Source&nbsp;Url</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("webhook_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_notify_url'])&&$_SESSION['tr_notify_url']==1))){?>
                  <div class="transaction-h2">Webhook&nbsp;Url</div>
                  <? }?>
				  
				  </th>
                 <th class="capc" scope="col"  valign="top">
                 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("return_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_success_url'])&&$_SESSION['tr_success_url']==1))){?>
                  <div class="transaction-h1">Return&nbsp;Url</div>
                  <? }?>
				  
				  </th>
                <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_amt'])&&$_SESSION['tr_mdr_amt']==1))){?>
                  <div class="transaction-h1">MDR&nbsp;Amt</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("gst_fee",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_gst_fee'])&&$_SESSION['tr_gst_fee']==1))&&($data['con_name']=='clk')){?>
                  <div class="transaction-h2">GST&nbsp;Fee</div>
                  <? }?>
				  <span class="hide">gst</span>
				  </th>
                  
				  <th class="capc" scope="col"  valign="top">
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("rrn",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_rrn'])&&$_SESSION['tr_rrn']==1))){?>
                  <div class="transaction-h1">RRN</div>
                  <? }?>
				  
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("buy_txnfee_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_txtfee_amt'])&&$_SESSION['tr_mdr_txtfee_amt']==1))){?>
                  <div class="transaction-h2">Buy&nbsp;TxnFee&nbsp;Amt</div>
                  <? }?>
				  ...
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("rolling_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_rolling_amt'])&&$_SESSION['tr_rolling_amt']==1))){?>
                  <div class="transaction-h1">Rolling&nbsp;Amt</div>
                  <? }?>
				   <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_cb_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_cb_amt'])&&$_SESSION['tr_mdr_cb_amt']==1))){?>
                  <div class="transaction-h2">MDR&nbsp;cb&nbsp;Amt</div>
                  <? }?>
				  
				  </th>
                  
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_cbk1_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_cbk1_amt'])&&$_SESSION['tr_mdr_cbk1_amt']==1))){?>
                  <div class="transaction-h1">MDR&nbsp;cbk1&nbsp;amt</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_refundfee_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_refundfee_amt'])&&$_SESSION['tr_mdr_cbk1_amt']==1))){?>
                  <div class="transaction-h2">MDR&nbsp;RefundFee&nbsp;Amt</div>
                  <? }?>
				  </th>
                  
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("payable_amt_of_txn",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_payable_amt_of_txn'])&&$_SESSION['tr_payable_amt_of_txn']==1))){?>
                  <div class="transaction-h1">Payable&nbsp;Amt&nbsp;of&nbsp;Txn</div>
                  <? } ?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("settelement_date",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_payout_date'])&&$_SESSION['tr_payout_date']==1))){?>
                  <div class="transaction-h2">Settelement&nbsp;Date</div>
                  <? }?>
				  </th>
                
                  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("risk_ratio",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_risk_ratio'])&&$_SESSION['tr_risk_ratio']==1))){?>
                  <div class="transaction-h1">Risk&nbsp;Ratio</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("transaction_period",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transaction_period'])&&$_SESSION['tr_transaction_period']==1))){?>
                  <div class="transaction-h2">Transaction&nbsp;Period</div>
                  <? }?>
				  </th>
                  <th class="capc" scope="col"  title="Bank Processing Amount" valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bank_processing_amount",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_bank_processing_amount'])&&$_SESSION['tr_bank_processing_amount']==1))){?>
                  <div class="transaction-h1">Bank&nbsp;Processing&nbsp;Amount</div>
                  <? }?>
				  </th>
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bank_processing_curr",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_bank_processing_curr'])&&$_SESSION['tr_bank_processing_curr']==1))){?>
                  <div class="transaction-h1" title="Bank Processing Currency">Bank&nbsp;Processing&nbsp;Curr</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_currency",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_currname'])&&$_SESSION['tr_currname']==1))){?>
                  <div class="transaction-h2" title="Bank Order Currency">Bill&nbsp;Currency</div>
                  <? }?>
				  </th>
                  ...
                  <div class="transaction-h1">MOP</div>
                  <? }?>
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("trans_type",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_trans_type'])&&$_SESSION['tr_trans_type']==1))){?>
                  <div class="transaction-h2">Trans&nbsp;Type</div>
                  <? }?>
				  </th>
                  
                 <th class="capc" scope="col"   valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_phone",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_bill_phone'])&&$_SESSION['tr_bill_phone']==1))){?>
                  <div class="transaction-h1">Bill&nbsp;Phone</div>
                  <? }?></th>
				  <th class="capc" scope="col"  valign="top">
                 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("product_name",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_product_name'])&&$_SESSION['tr_product_name']==1))){?>
                  <div class="transaction-h1">Product&nbsp;Name</div>
                  <? }?>
				  </th>
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_address",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_address'])&&$_SESSION['tr_address']==1))){?>
                  <div class="transaction-h1">Bill&nbsp;Address</div>
                  <? }?>
				  <div class="transaction-h2">
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_city",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_city'])&&$_SESSION['tr_city']==1))){?>
                  Bill&nbsp;City
                  <? }?>
				  
				  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_state",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_state'])&&$_SESSION['tr_state']==1))){?>
                  / Bill&nbsp;State
                  <? }?>
				  </div>
				  </th>
				  ...
				  <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("country",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_country'])&&$_SESSION['tr_country']==1))){?>
                  <div class="transaction-h1">Bill&nbsp;Country</div>
                  <? }?>
				   <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_zip",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_zip'])&&$_SESSION['tr_zip']==1))){?>
                  <div class="transaction-h2">Bill&nbsp;Zip</div>
                  <? }?>
				  </th>
                 <th class="capc" scope="col"  valign="top">
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("descriptor",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_descriptor'])&&$_SESSION['tr_descriptor']==1))){?>
              ...
              <tr valign="top" class="text-start">
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("transID",$_SESSION['transaction_display_arr'])){?>
				...
				<td data-bs-toggle="tooltip" data-bs-placement="top" valign="top" title="<?=$value['transID'];?>">
			...
			elseif($value['ostatus']=="3" || $value['ostatus']=="5" || $value['ostatus']=="6" || $value['ostatus']=="11" || $value['ostatus']=="12"){ echo 'R'; }?><?=substr($value['transID'],0,14);?>
                  ...
                  <? if(isset($_SESSION['transaction_display_arr'])&&in_array("reference",$_SESSION['transaction_display_arr'])){?>
                <div title="<?=$value['reference']?>" data-bs-toggle="tooltip" data-bs-placement="top" style="width:90px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;" class="mx-0 transaction-list-h2">
                    <?=$value['reference'];?>
                  </div>
                <? }?> 
  ...
  <? }?>
                ...
                <? }?>
				 ...
				 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bearer_token",$_SESSION['transaction_display_arr'])){?>
                <td nowrap valign="top"> 
					<?if(isset($value['json_log_history'])&&trim($value['json_log_history'])){
						$acquirer_response1=jsonencode1($value['json_log_history'],'',1);
					?>
                    <div class="transaction-list-h1"  data-mid="<?=$value['id']?>" data-ihref="<?=$data['Admins']?>/json_log_all<?=$data['ex']?>?tablename=master_trans_table&clientid=<?=$value['merID']?>&action_name=<?=$value['bearer_token']?>" onclick="iframe_open_modal(this);" style="cursor:pointer;" title="Json Log History" data-bs-toggle="tooltip" data-bs-placement="bottom"><i class="<?=$data['fwicon']['circle-info'];?> text-info"></i></div>
					<? } ?>
					<? if(isset($value['bearer_token'])&&trim($value['bearer_token'])){ ?>
						<a onClick="load_popup_jsonf('<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>','<?=encryptres($acquirer_response1);?>','jsonLogHisotry');" class="transaction-list-h2 nomid btn btn-outline-danger btn-sm my-2"  title="<?=$value['bearer_token']?>" id="acqresp" style="padding: 1px 5px;margin:1px !important;"><?=$value['bearer_token']?></a>
					<?}?>
				...
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("fullname",$_SESSION['transaction_display_arr'])){?>
				<div class="transaction-list-h1"><?=prntext(lf($value['fullname'],15,1));?>  </div>               
				<? }?>
				
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_email",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_bill_email'])&&$_SESSION['tr_bill_email']==1))){?>
                <div class="transaction-list-h2"><?=prntext($value['bill_email']);?></div>
                <? }?>
			
				
				</td>
                <td  class="pricecolor" nowrap valign="top">
				
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("amount",$_SESSION['transaction_display_arr'])){?>
                <div class="transaction-list-h1 pricecolor"><?=$value['bill_amt']?></div>
                <? }?>
				
				
				
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("trans_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transaction_amt'])&&$_SESSION['tr_transaction_amt']==1))){?>
                <div class="transaction-list-h2 pricecolor"><?=$value['trans_amt']?></div>
                <? }?>
	  ...
	  if(isset($img)&&trim($img)&&$img=="nocc.png"&&empty($fwicon)){ $fwimg=1; $fwicon=$data['fwicon']['nocc']; }
	   ...
	   ?>
                  ...
                  <? if($fwimg==0){ ?>
                  <img src="<?=$data['Host']?>/images/<?=$img?>" class="img-fluid img-hover 44" alt="<?=(isset($txt)&&trim($txt)?$txt:'')?>" style="max-height:18px;">
                  <? }else{ echo $fwicon; ?>
                  <? } ?>
                  </a>
                <? }?>
<? if(isset($_SESSION['transaction_display_arr'])&&in_array("type",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_type'])&&$_SESSION['tr_type']==1))){?>
<? if((isset($_SESSION['login_adm']))||(isset($_SESSION['t_acquirer_view'])&&$_SESSION['t_acquirer_view']==1)){?>
                <div class="transaction-h2" style="width:150px;"><?=$value['acquirer']?></div>
                <? }?>
                <? }?>
               ...
               <? if(isset($data['wdata1']) && $data['wdata1']=='5'){?>
                  ...
                  <? }else {echo $value['trans_status'];}?>       
                <? }?>
                <? }?>
				</div>
				 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("reason",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_reason'])&&$_SESSION['tr_reason']==1))){?>
                <div class="transaction-list-h2" style="width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                ...
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_ip",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_ip'])&&$_SESSION['tr_ip']==1))){?>
				<div class="transaction-list-h1">
                <a onclick="iframe_open_modal(this);" class="dotdot nomid" data-ihref='<?=$data['Host'];?>/include/ips<?=$data['ex']?>?remote=<?=$value['bill_ip']?>' title='IP: <?=prntext($value['bill_ip']);?>' data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext(lf($value['bill_ip'],15,1));?></a>
				</div>
                  
                <? } ?>
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("terNO",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_terNO'])&&$_SESSION['tr_terNO']==1))){?>
                <div class="transaction-list-h2"><?=$value['terNO']?></div>
                <? }?>
				
				</td>
                <td valign="top" >
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("acquirer_ref",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_txn_id'])&&$_SESSION['tr_txn_id']==1))){?>
                <div class="transaction-list-h1"><?=$value['acquirer_ref']?></div>
                <? }?>
				</td>
				<td  nowrap valign="top">
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("acquirer_response",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_acquirer_response'])&&$_SESSION['tr_acquirer_response']==1))){?>
                 <div class="transaction-list-h1">
				 <a class="dotdot nomid text-link modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?json=<?=encryptres($value['acquirer_response']);?>' ><?=prntext(lf($value['acquirer_response'],15,1));?></a>
				  </div>
 ...
 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("support_note",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_support_note'])&&$_SESSION['tr_support_note']==1))){?>
<div class="transaction-list-h1">
<a onclick="iframe_open_modal(this);" class="dotdot nomid text-link" data-ihref='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['support_note']);?>' style="height:20px;" >Note Support</a>
</div>
<? } ?>
<? if(isset($_SESSION['transaction_display_arr'])&&in_array("system_note",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_system_note'])&&$_SESSION['tr_system_note']==1))){?>
<div class="transaction-list-h2">
...
<? if(isset($_SESSION['transaction_display_arr'])&&in_array("webhook_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_notify_url'])&&$_SESSION['tr_notify_url']==1))){?>
<div class="transaction-list-h2">
<a class="dotdot nomid text-link modal_for_iframe" ihref='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['webhook_url']);?>' style="height:20px;overflow:hidden;" ><?=prntext(lf($value['webhook_url'],15,1));?></a>
 </div>                 
               ...
               <? if(isset($_SESSION['transaction_display_arr'])&&in_array("return_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_success_url'])&&$_SESSION['tr_success_url']==1))){?>
				<div class="transaction-list-h1">
                <a class="dotdot nomid text-link modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['return_url']);?>' style="height:20px;overflow:hidden;" >
               ...
               <td  nowrap valign="top">
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_amt'])&&$_SESSION['tr_mdr_amt']==1))){?>
 <div class="transaction-list-h1"><? if(isset($value['mdr_amt'])&&$value['mdr_amt']){ echo $value['mdr_amt']; } ?></div>
                <? }?>
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("gst_fee",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_gst_fee'])&&$_SESSION['tr_gst_fee']==1))&&($data['con_name']=='clk')){?>
                ...
                <? }?>
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("buy_txnfee_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_txtfee_amt'])&&$_SESSION['tr_mdr_txtfee_amt']==1))){?>
                <div class="transaction-list-h2"><?=$value['buy_txnfee_amt'];?></div>
                <? }?>
				</td>
               ...
               <? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_cbk1_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_cbk1_amt'])&&$_SESSION['tr_mdr_cbk1_amt']==1))){?>
                ...
                <? }?>
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("mdr_refundfee_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_refundfee_amt'])&&$_SESSION['tr_mdr_refundfee_amt']==1))){?>
               ...
               <? if(isset($_SESSION['transaction_display_arr'])&&in_array("payable_amt_of_txn",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_payable_amt_of_txn'])&&$_SESSION['tr_payable_amt_of_txn']==1))){?>
                ...
                <? }?>
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("settelement_date",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_payout_date'])&&$_SESSION['tr_payout_date']==1))){?>
                <div class="transaction-list-h2"><?=prndate($value['settelement_date']);?></div>
                <? }?>
				</td>
                ...
                <? }?>
				 <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_currency",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_currname'])&&$_SESSION['tr_currname']==1))){?>
                <div class="transaction-list-h2"><?=$value['bill_currency'];?></div>
                <? }?>
				...
				<td nowrap valign="top"  nowrap title="MOP: <?=$value['mop'];?>" data-label="MOP" data-bs-toggle="tooltip" data-bs-placement="top"> 
                <? if(in_array("transID",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mop'])&&$_SESSION['tr_mop']==1))){
				?>
                <? if(isset($value['mop'])&&$value['mop']){ ?>
                  <div class="transaction-list-h1"><?=$value['mop'];?></div>
                  <? } ?>
                <? } ?>
				
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("trans_type",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_trans_type'])&&$_SESSION['tr_trans_type']==1))){?>
                <div class="transaction-list-h1"><?=$value['trans_type'];?></div>
                <? }?>
               ...
               <td  nowrap valign="top">
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_phone",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_bill_phone'])&&$_SESSION['tr_bill_phone']==1))){?>
                <div class="transaction-list-h1"><?=prntext($value['bill_phone']);?></div>
                <? }?>
				</td>
				<td  nowrap valign="top">
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("product_name",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_product_name'])&&$_SESSION['tr_product_name']==1))){?>
                ...
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_address",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_address'])&&$_SESSION['tr_address']==1))){?>
				<div class="transaction-list-h1">
                <a class="dotdot nomid modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?json=<?=encryptres($value['bill_address']);?>'><?=prntext(lf($value['bill_address'],15,1));?></a>
				</div>
                <? }?>
				<div class="transaction-list-h2">
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_city",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_city'])&&$_SESSION['tr_city']==1))){?>
                <?=prntext($value['bill_city']);?>
                <? }?>
				
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_state",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_state'])&&$_SESSION['tr_state']==1))){?>
                / <?=prntext($value['bill_state']);?>
                <? }?>
				</div>
				</td>
				...
				<td valign="top" >
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("country",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_country'])&&$_SESSION['tr_country']==1))){?>
                <div class="transaction-list-h1"><?=prntext($value['bill_country']);?></div>
                <? }?>
				<? if(isset($_SESSION['transaction_display_arr'])&&in_array("bill_zip",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_zip'])&&$_SESSION['tr_zip']==1))){?>
                <div class="transaction-list-h2"><?=prntext($value['bill_zip']);?></div>
                <? }?>
				</td>
                <td  nowrap valign="top">
                <? if(isset($_SESSION['transaction_display_arr'])&&in_array("descriptor",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_descriptor'])&&$_SESSION['tr_descriptor']==1))){?>
