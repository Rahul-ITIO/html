...
<div class="container border my-1 vkg rounded">
	...
	<? if ((isset($data['Error'])&& $data['Error']) && (!$post['change2way'])){?>
		...
		<? if($data['MYWEBSITE']||$_REQUEST['a']){?>	
			...
			<a href="<?=$data['Host']?>/plugins/indcashless-woocommerce-plugin.zip" target="_blank" title="WP Plugins Download">indcashless-woocommerce-plugin.zip</a> 
			<hr />
			<h4>WHMCS Plugins (<?=($data['SiteName']);?>) Download </h4> 
			<a href="<?=$data['Host']?>/plugins/indcashless-whmcs.zip" target="_blank" title="WHMCS Download">indcashless-whmcs.zip</a> 
			<hr />
