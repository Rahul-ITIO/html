...
<div class="col">
	...
	<label for="vtid">Payout Request</label>
	...
	<select name="payout_request" id="payout_request" class="form-select w-100" title="Payout Request" >
		<option value="">Payout Request</option>
...
<div class="my-2" id="Payout_Scrubbed_Period">
	...
	<div class="row col-sm-6 my-2">
	  <div class="col-sm-4">
		<label title="Min. Transaction Limit:">Min. Transaction Limit: <i class="fa-solid fa-star-of-life  text-danger"></i></label>
	  </div>
	  <div class="col-sm-8">
		<input type="text" name="min_limit" id="p_min_limit" class="form-control" title="Min. Transaction Limit" value="<?=(isset($post['min_limit'])?$post['min_limit']:'');?>" oninvalid="alert('Please Fill Min. Transaction Limit');">
	  </div>
	</div>
	<div class="row col-sm-6 my-2">
	  <div class="col-sm-4">
		<label title="Max. Transaction Limit">Max. Transaction Limit: <i class="fa-solid fa-star-of-life  text-danger"></i></label>
	  </div>
	  <div class="col-sm-8">
		<input type="text" name="max_limit" id="p_max_limit" class="form-control" value="<?=(isset($post['max_limit'])?$post['max_limit']:'');?>"  oninvalid="alert('Please Fill Max. Transaction Limit');" >
	  </div>
	</div>
	<div class="row col-sm-6 my-2">
	  <div class="col-sm-4">
