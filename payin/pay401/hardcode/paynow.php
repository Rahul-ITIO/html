...
//$request['header']['signature']="dIiDxUflgSA:APA91bGCQb8_cJxKkqSPihKX-6f2XdPs65eCeZMgEZubnRofXMftVpxiv9lVuLVjjIlB8RnCLuYDfqkIzA3Mb_5Y4ERGH655VJs3g-FPhurL6cFpFSejdgJFy6lgYCH3nrK6nbaf0YHO";


$request['data']['amountSettled']="5000";
$request['data']['currency']="SGD";
$request['data']['totalAmount']="5000";
$request['data']['eType']="77780";
$request['data']['description']="ewalletqq";
...
?>
		...
		<img src="https://quickchart.io/chart?chs=300x300&cht=qr&chl=<?=$qrdata;?>&choe=UTF-8" title="" / style="float:right; background-color:blue;">
<?
