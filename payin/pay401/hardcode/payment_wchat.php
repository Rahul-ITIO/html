...
$request['header']['appType']="A";
$request['header']['appVersion']="S2.00.00";
$request['header']['mcpTerminalId']="7020120009";
$request['header']['uuid']="ThisIsPhoneUUID";

$request['data']['userId']="next";
$request['data']['password']="838a0890a3fcdc093d04a40783c8b453d5bc62d8cccd98a06c19ea69c2bbee162c491f81222331aac4025862fd3626d713f156c7f4ab154844f04ccd0bd287d4";
$request['data']['timeStamp']="20170530145818";
//$request['data']['eType']="77771";
//$request['data']['serialNo']="FDSER0001";
//$request['data']['ipAddress']="192.168.1.1";
...
$result = sendRequest('https://gw2.mcpayment.net/api/v5/auth/terminal', $request);
		
echo "<br/><hr/>result=><br/>".$result;
$result1=json_decode($result,1);
print_r($result1);

		//$qrdata = $result1['data']['signKey'];
