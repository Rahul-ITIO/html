<?php
//localhost:8080/gw/payin/pay119/hardcode/pesaway_119_2.php
//https://aws-cc-uat.web1.one/payin/pay119/hardcode/pesaway_119_2.php
?>
<?php
...
// === ORDER DETAILS ===
$order_number = "orde-".date('YmdHis')."-".rand(1000,9999);
...
echo "<br/><hr/><br/>session_hash=>".$session_hash."<br><br><hr/><br>";
...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://pay.pesaway.com/api/v1/session',
