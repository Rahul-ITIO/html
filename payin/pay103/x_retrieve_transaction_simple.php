    ...
    <table width="60%" align="center" cellpadding="5" border="0">
      ...
      <!-- Credit Card Fields -->
        ...
        <tr>
            ...
            <td width="50%"><input type="text"  name="version" value="72" size="8" maxlength="80" /></td>
        </tr>
        <tr class="shade">
            <td align="right" width="50%"><strong>order.id </strong></td>
            <td><input type="text" name="orderId" value="240327082313000000" size="20" maxlength="60"/></td>
        </tr>
        <tr>
            <td align="right" width="50%"><strong>transaction.id </strong></td>
            <td><input type="text" name="transactionId" value="trans-682" size="20" maxlength="60"/></td>
        </tr>
        ...
        <tr>
            ...
            <td width="50%"><input type="text"  name="method" value="GET" size="20" maxlength="80"/> ** See Note 1 Below</td>
        </tr>


        <tr class="shade">
             <td align="right" width="50%"><strong>apiOperation </strong></td>
             <td width="50%"><input type="text"  name="apiOperation" value="CAPTURED" data-ba="RETRIEVE_TRANSACTION" size="20" maxlength="80"/></td>
         </tr>
