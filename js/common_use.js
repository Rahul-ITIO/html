...
jQuery.noConflict();
$.noConflict();
function redirectPostf(url, data) {
...
*/
// redirectPostf('http://www.example.com', { text: 'text view' });
...
var vp='';
//display modal form
function hrefmodal(theUrl,eThis=''){	
	//alert(theUrl);
...
function iframe_checkf(){
	 $("#modal_popup_iframe_div").html('<iframe src="about:blank" name="modal_popup_iframe" id="modal_popup_iframe" frameborder="0" marginwidth="0" marginheight="0" class="modal_popup_iframe" width="100%" height="400"></iframe>');
}
...
function add_more_files(e,theInputs,theFun=''){
	...
	$(e).before($("<div/>", {id: 'filediv'}).fadeIn('slow').append(
		$("<input/>", {name: theInputs, type: 'file', class: 'mfile file_'+abc, onchange: 'imageIsChange(this,'+theFun+')', id: 'file'}),        
		$("")
	));
...
function add_more_files2(e,theInputs,theFun=''){
	...
	$(e).before($("<div/>", {id: 'filediv'}).fadeIn('slow').append(
		$("<input/>", {name: theInputs, type: 'file', class: 'mfile file_'+abc, onchange: 'imageIsChange(this,'+theFun+')', id: 'file', accept: 'image/*', capture: 'camera'}),        
		$("")
	));
...
function uploadfile_viewf(theValue,fileType='img'){
