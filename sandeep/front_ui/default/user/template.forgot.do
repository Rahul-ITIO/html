      ...
      <form method="post">
        ...
        <div class="mb-3 row-fluid">
          ...
          <div class="col-sm-12 input-field">
            <input type="text" class="form-control cemail" name="registered_email" id="input_username" title="Enter username registered with us" value="<?=prntext($post['registered_email'])?>" autocomplete="off" data-bs-toggle="tooltip" data-bs-placement="top" required/>
