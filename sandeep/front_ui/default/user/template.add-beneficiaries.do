	...
	<div class="container my-2 py-2 border rounded" >
		<div class="row vkg">
			<div class="col-sm-12 mb-2">
				<h4 class="float-start"><i class="fa fa-user"></i> Beneficiary - Single Add</h4>
			</div>
		</div>
...
<label for="beneficiary_nickname">Nick Name <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
			...
			<label for="beneficiary_name">Beneficiary Name <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
				...
				<div class="form-floating mb-3 px-0">
					...
					<label for="account_number">Account Number <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
				</div>
				<div class="form-floating mb-3 px-0">
					...
					<label for="repeated_account_number">Repeat Account Number <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
				</div>
				<div class="form-floating mb-3 px-0">
				...
				<div class="form-floating mb-3 px-0">
					...
					<label for="bank_code1">Bank Code <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
				</div>
				
				<div class="form-floating mb-3 px-0">
					<input type="text" class="form-control" name="bank_code2" id="bank_code2" placeholder="Bank Code 2" autocomplete="off">
					<label for="bank_code2">Bank Code 2</label>
				</div>
				<div class="form-floating mb-3 px-0">
