<?php
//http://localhost/gw/api-test/binopay/staus_via_transID.php?transID=8723122601
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api1.dataprotect.site/api/transaction/v1/transactions/{$transaction_number}/status",
