...
.tbl_exl {width: 80vw !important;}
 ...
 <div class="row">
  <div><? echo json_log_view1($post['json_log_history'],'View Json Log','0','json_log','','100');?></div>
  </div>
...
$("#multiple_merchant_ids_chosen").addClass("form-control");
      ...
      <div class="col-sm-6">
        <span class="form-label d-none d-sm-block" id="basic-addon4" >Username: <i class="<?=$data['fwicon']['star'];?>  text-danger"></i></span>
      ...
      <div class="col-sm-6">
        <span class="form-label d-none d-sm-block" id="basic-addon4" >
          ...
          <? } else { ?>
          <? if((isset($_SESSION['login_adm']))||(isset($_SESSION['change_password'])&&$_SESSION['change_password']==1)){ ?>
          <a href="<?=$data['Admins'];?>/password<?=$data['ex']?>?id=<?=$_GET['id']?>" class="btn btn-outline-secondary" title="Change Password"><i class="<?=$data['fwicon']['unlock'];?>" title="Change"></i> </a>
          <? }?>
          <? } ?>
        </div>
     
      <div class="col-sm-6">
       <span class="form-label d-none d-sm-block" id="basic-addon4" >Email: <i class="<?=$data['fwicon']['star'];?>  text-danger"></i></span>
      ...
      <div class="col-sm-6">
        <span class="form-label d-none d-sm-block" id="basic-addon4" >Full Name: <i class="<?=$data['fwicon']['star'];?>  text-danger"></i></span>
      ...
      <div class="col-sm-6 d-none">
        <span class="form-label d-none d-sm-block" id="basic-addon4" >Last Name:</span>
      ...
      <div class="col-sm-6">
        <span class="form-label d-none d-sm-block" id="basic-addon4" >Role: <i class="<?=$data['fwicon']['star'];?>  text-danger"></i></span>
    ...
    <span class="form-label d-none d-sm-block" id="basic-addon4" >Front UI:</span>
      ...
      <div class="col-sm-6 d-none">
        <span class="form-label d-none d-sm-block" id="basic-addon4" >Bussiness URL:</span>
	   ...
	   <div class="col-sm-6 d-none">
    <span class="form-label d-none d-sm-block" id="basic-addon4" >Contact US URL:</span>
	  ...
	  <div class="col-sm-6">
    <span class="form-label d-none d-sm-block" id="basic-addon4" >Color Theme:</span>
      <select name="upload_css" id="upload_css" class="form-select" data-rel="chosen" onChange="change_color(this.value)"  >
	  ...
	  <div class="col-sm-6">
    <span class="form-label d-none d-sm-block" id="basic-addon4" >UI Panel:</span>
 ...
 <? if($post['action']=="insert"){ ?>
      <div class="col-sm-6">
    <span class="form-label d-none d-sm-block" id="basic-addon4" title="2 Way Auth. Access:" >2 Way Auth.:</span>
...
<div class="collapse rounded border clearfix p-2 my-2" id="collapseAdvance">
  ...
  <div class="row pb-2">
      <div class="col-sm-6">
    <span class="form-label d-none d-sm-block" id="basic-addon4" >Domain Name:</span>
      ...
      <div class="col-sm-6">
    <span class="form-label d-none d-sm-block" id="basic-addon4" >Domain Status:</span>
      ...
      <div class="col-sm-6">
        <span class="form-label d-none d-sm-block" id="basic-addon4" title="Support No." >Support No. :</span>
      ...
      <div class="col-sm-6">
        <span class="form-label d-none d-sm-block" id="basic-addon4" title="Support Email" >Support Email:</span>
...
//default !! ice1 !! ice2 !! zinc !! quartz

//alert(template);
if(template=="ice1"){
$('#upload_css option[value="pmc"]').prop('selected','selected');
$('#front_ui_panel option[value="Left_Panel"]').prop('selected','selected');
change_color("pmc");

}else if(template=="ice2"){
$('#upload_css option[value="vmc"]').prop('selected','selected');
$('#front_ui_panel option[value="Left_Panel"]').prop('selected','selected');
change_color("vmc");

}else if(template=="quartz"){
$('#upload_css option[value="quartz"]').prop('selected','selected');
$('#front_ui_panel option[value="Left_Panel"]').prop('selected','selected');
change_color("quartz");

}else if(template=="opal"){
$('#upload_css option[value="opal"]').prop('selected','selected');
$('#front_ui_panel option[value="Left_Panel"]').prop('selected','selected');
change_color("opal");

}else if(template=="OPAL_IND"){
$('#upload_css option[value="OPAL_IND"]').prop('selected','selected');
$('#front_ui_panel option[value="Left_Panel"]').prop('selected','selected');
change_color("OPAL_IND");

}else if(template=="zinc"){
$('#upload_css option[value="blue"]').prop('selected','selected');
$('#front_ui_panel option[value="Left_Panel"]').prop('selected','selected');
change_color("blue");
