				...
				<div  class="col-sm-11 text-start ps-0 pt-2" >
					...
					<div class="start-float map_f1" style="font-size: 10px;">
						...
						<?if(isset($_REQUEST['date_range'])){?>
							<b>DATE RANGE: </b> <span style="font-size: 14px;"><?=@$_REQUEST['date_range'];?></span> <s>|</s>
						<?}?>
...
<input type="text" name="date_range2" class="form-control form-control-sm bg-primary text-white" id="date_range" placeholder="Custom Date Range" value="<? if(isset($_REQUEST['date_range2'])) echo $_REQUEST['date_range2'];?>" style="" required1 />

<label for="date_range" ><i class="<?=$data['fwicon']['calender'];?> cals fs-2x text-link float-start"  style="font-size: 11px;z-index:0;float: left !important;position: relative;margin: -5px 2px 0 0;" ></i> Date Range <i id="label_date_range"><?=@$_REQUEST['date_label'];?> </i> </label>
