...
$(document).ready(function(){ 
    ...
    <div class="container row text-end px-0 title_addnew_common">
      ...
      <div class="col-sm-3 my-2 ps-0 text-end">
        ...
        <button type="submit" name="send" value="Add A New Acquirer!"  class="btn btn-primary" title="Add A New Acquirer"><i></i><i class="<?=$data['fwicon']['circle-plus'];?>"></i></button>
      </div>
    </div>
			...
			<?}?> 
                ...
                <div class="row col-sm-6">
                  <div class="card my-2">MOP [WEB]:
                    <span class="mop_div btn btn-abv-search text-start"  style="width:max-content;padding:5px 5px 8px 5px;margin:2px 0 5px 0;"><?=mop_option_list_f(2,$value['mop']);?> </span>
                  </div>
                </div>
                <? } ?>
				...
				<div class="row border bd-blue-100 text-start vkg px-2 my-2 rounded" >
					...
					<div class=" col-sm-6">
					  <div class="card my-2 ps-2" title="Logo for web">Logo [web]:
					...
					<div class=" col-sm-6">
					  <div class="card my-2 ps-2" title="Logo for mobile">Logo [mobile]:
...
$("#mcc_code_no_add_chosen").addClass("form-control");
      ...
      <div class="col-sm-6"> <span class="form-label" >Acquirer Activation : <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
        <select name="acquirer_status" id="acquirer_status" class="form-select" required >
          <option value="" disabled selected>Acquirer Status</option>
      ...
      <div class="col-sm-6">
        <div class=""> <span class="form-label" >Acquirer Mode : <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
      ...
      <div class="col-sm-6">
        <div class=""> <span class="form-label" >Acquirer No.: <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
          <input type="text" name="acquirer_id" id="acquirer_id" placeholder="Enter Acquirer No. for Your API" class="form-control" value="<? if(isset($post['acquirer_id'])) echo prntext($post['acquirer_id'])?>" required />
        </div>
      </div>
	  <div class="col-sm-6">
        <div class=""> <span class="form-label" >Default Acquirer: <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
          <input type="text" name="default_acquirer" id="default_acquirer" placeholder="Enter Default Acquirer No. for Your API" class="form-control" value="<? if(isset($post['default_acquirer'])) echo prntext($post['default_acquirer'])?>" required />
        </div>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-sm-6"> <span class="form-label" >Acquirer Payment Live/Prod. URL: <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
      ...
      <div class="col-sm-6"> <span class="form-label" >Acquirer Payment Test/Uat. URL : </span>
      ...
      <div class="col-sm-6"> <span class="form-label" >Acquirer Status URL : <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
      ...
      <div class="col-sm-6"> <span class="form-label " >Acquirer Refund URL : </span>
      ...
      <div class="col-sm-6"> <span class="form-label w-100" >Acquirer Refund Policy :  <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
	  ...
	  <div class="col-sm-6"> <span class="form-label " >Acquirer Descriptor : </span>
		 <input type="text" name="acquirer_descriptor" id="acquirer_descriptor" placeholder="Enter Acquirer Descriptor for Your API" class="form-control" value="<? if(isset($post['acquirer_descriptor'])) echo ($post['acquirer_descriptor'])?>"  />
      </div>
      ...
      <div class="col-sm-6"> <span class="form-label " >Acquirer Whitelisting IP / Webhook url : 
      ...
      <div class="col-sm-6"> <span class="form-label " >Acquirer Login Credentials : </span>
      ...
      <div class="col-sm-6"> <span class="form-label " >Acquirer Developer API URL : </span>
      ...
      <div class="col-sm-6"> <span class="form-label "  title="Domain for Callback/Process">Acquirer Whitelisting Domain: </span>
      ...
      <div class="col-sm-6"> <span class="form-label " >Acquirer Processing Currency :   <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
        <select name="acquirer_processing_currency"  class="form-select" id="acquirer_processing_currency"  required >
          <option value="" disabled selected>Acquirer Processing Currency *</option>
      ...
      <div class="col-sm-6"> <span class="form-label " >Currency Rate: </span>
	  ...
	  <div class="row border bd-blue-100 my-2 text-start py-2 vkgclr rounded">
        <div class="row btn btn-outline-light text-dark fw-bold mb-2">Acquirer Label Json</div>
		
		<div class="col-sm-12"> <span class="form-label" >Acquirer Processing Creds. : <i class="<?=$data['fwicon']['star'];?> text-danger"></i></span>
        ...
        <div class="col-sm-6 mt-2">
          <label for="acquirer_name" class="form-label" title="Name1">Acquirer Name : <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
	...
	<?*/?>
		...
		<div class="col-sm-6 mt-2">
          <label for="popup_msg_web_no_add" class="form-label" title="Name6 for Web">Acquirer Redirect Popup Msg [web] :</label>
		...
		?>
		  <select id="popup_msg_web_no_add" data-placeholder="Acquirer Redirect Popup Msg [web] " multiple class="chosen-select form-control" name="popup_msg_web[]" style="clear:right;" >
            <?
       ...
       <div class="col-sm-6 mt-2">
          <label for="popup_msg_mobile_no_add" class="form-label" title="Name6 for Mobile">Acquirer Redirect Popup Msg [mobile] :</label>
		  <?if(!isset($data['arpm']))
		  {?>
		  ...
		  <?}else {?>
			...
			?>
			  <select id="popup_msg_mobile_no_add" data-placeholder="Acquirer Redirect Popup Msg [mobile] " multiple class="chosen-select form-control" name="popup_msg_mobile[]" style="clear:right;" >
				<?
				foreach($data['arpm'] as $ke){
					echo "<option value='{$ke}'>{$ke}</option>";
				}
		...
		<div class="col-sm-6 mt-2">
          <label for="logo_web" class="form-label" title="Logo for Web">Logo [web] : <i class="<?=$data['fwicon']['star'];?> text-danger"></i></label>
       ...
       <div class="col-sm-6 mt-2">
          <label for="logo_mobile" class="form-label" title="Logo for Mobile">Logo [mobile]:</label>
...
<?/*?>
	...
	<?*/?>			
      ...
      <div class="row border bd-red-100 my-2 text-start py-2 vkg text-dark rounded">
        ...
        <div class="col-sm-6">
<label for="Acquirer ID" class="form-label">Acquirer Display Order: </label>
          <?
          ...
          <select class='slc_color form-select' name="acq[acquirer_display_order]" id="acquirer_display_order" title="Rolling Period"  >
            ...
            <option title="<?=($post['acq']['acquirer_display_order']==$f?"Current":"Added")?> in <?=array_search($f,$_SESSION['shorting_ar']);?> Acquirer" value="<?=$f;?>" <?=($post['acq']['acquirer_display_order']==$f?"":" disabled='disabled'")?> >
            <?=$f;?>
            :
...
<?*/?>	
      ...
      <div class="row border bd-green-100 my-2 me-2 text-start py-2 px-2 border text-dark rounded">
        ...
        <div class="col-sm-6">
          <label for="Acquirer ID" class="form-label" title="aPj">Acquirer Processing Json:</label>
