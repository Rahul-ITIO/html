...
<li><a class="nav-link <?=$class_a_1?> " href="<?=$data['Host']?>/payout/payoutapi.pdf" target="_blank" title="Api Keys"><i class="<?=$data['fwicon']['pdf'];?> fa-fw"></i> <span class="menu_title">Developer API</span></a></li>
<li class="my-1 ice2-show"><div class="underline mx-2"></div></li>
<? } ?>