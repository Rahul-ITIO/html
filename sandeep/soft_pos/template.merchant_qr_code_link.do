...
<li><a class="nav-link <?=$class_a_1?> " href="<?=$data['USER_FOLDER']?>/qr-transactions<?=$data['ex']?>" title="QR Transactions"><i class="<?=$data['fwicon']['transaction'];?> fa-fw"></i> <span class="menu_title">Transactions</span></a></li>
<li class="px-2 my-1 ice1-show"><div class="hr-line"></div></li>
<li class="my-1 ice2-show"><div class="underline mx-2"></div></li>
