...
(function (global, factory) {
                ...
                for (i = 0; (el = inSelector.elements[i]); i++) {
                    ...
                    if (el.value !== '&') {
                        ...
                        if (nestedSelector != null) {
                            ...
                            // the nestedPaths array should have only one clients - replaceParentSelector does not multiply selectors
    ...
    ***************************************************************************** */
    ...
    var CSSVisitorUtils = /** @class */ (function () {
        ...
        CSSVisitorUtils.prototype.keepOnlyVisibleChilds = function (clientid) {
            if (clientid && clientid.rules) {
                clientid.rules = clientid.rules.filter(function (thing) { return thing.isVisible(); });
            }
        };
        CSSVisitorUtils.prototype.isEmpty = function (clientid) {
            return (clientid && clientid.rules)
                ? (clientid.rules.length === 0) : true;
        };
