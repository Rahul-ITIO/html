	...
	2: [function (a, b, c) {
		...
		! function (a, c) {
			...
			return v = function (a) {
				...
				if (a) return c = u(c), null != a.addEventListener ? a.addEventListener(b, c, !1) : a.attachEvent("on" + b, c)
			}, m = {}, c = /(\d{1,4})/g, m.cards = [{
				type: "visaelectron",
				...
				return w(a, "keypress", t), w(a, "keypress", r), w(a, "keypress", h), w(a, "keydown", e), w(a, "change", o), w(a, "input", o)
			}, m.numericInput = function (a) {
				return w(a, "keypress", t), w(a, "change", t), w(a, "input", t)
