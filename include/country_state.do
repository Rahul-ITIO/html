...
function get_country_code($country,$names=0,$valid=0){
	...
	if($country=="Afghanistan"  || $country=="AF" || $country=="AFG"){
	 ...
	 $country_1="Guadeloupe";  $country_2="GP"; $country_3="GLP"; $currency='EUR'; $isd_code='590';
	...
	elseif($country=="Qatar" || $country=="QA" || $country=="QAT"){
	 ...
	 $country_1="Uruguay";  $country_2="UY"; $country_3="URY"; $currency='UYU'; $isd_code='598';
	 ...
	 $country_1="Virgin Islands, US";  $country_2="VI"; $country_3="VIR"; $currency='USD'; $isd_code='1';
