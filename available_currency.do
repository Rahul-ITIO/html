<?
$data['AVAILABLE_CURRENCY']=array("AUD","BTC","CAD","CNY","CZK","EUR","GBP","HKD","IDR","INR","JPY","KHR","MXN","MYR","PHP","PLN","SGD","THB","USD","VND","NGN","ZMW");

$data['AVAILABLE_CURRENCY_MEANING']=array("AUD"=>"Australia Dollar","BTC"=>"Bitcoin","CAD"=>"Canadian Dollar","CNY"=>"Chinese Yuan","CZK"=>"Czech koruna","EUR"=>"Euro","GBP"=>"United Kingdom Pound","HKD"=>"Hong Kong Dollar","IDR"=>"Indonesian Rupiah","INR"=>"Indian Rupee","JPY"=>"Japanese Yen","KHR"=>"Cambodian riel","MXN"=>"Mexican Peso","MYR"=>"Malaysian Ringgit","PHP"=>"Philippine peso","PLN"=>"Polish złoty","SGD"=>"SG Dollar","THB"=>"Thai baht","USD"=>"United States Dollar","VND"=>"Vietnamese dong","NGN"=>"Naira - Nigeria Currency","ZMW"=>"Zambia - Zambian Kwacha");
...
function get_currency($currency,$names=0){
	...
	elseif($currency=="ZMW"|| $currency=="ZMW"){
		$currency_name="ZMW";  $currency_symbol="ZMW"; 
	}
