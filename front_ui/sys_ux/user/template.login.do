...
<div class="container my-2" style="max-width:480px;"><!--style="max-width:400px;"-->
...
<? unset($_SESSION['errmsg']); } ?>
 ...
 <div class="container my-2" style="max-width:480px;">
...
<a href="<?=$data['Host'];?>/reset-password<?=$data['ex']?>" class="text-link" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Click here to reset password">Reset password?</a></span></label>
        ...
        <div class="mb-3 row-fluid">
          <div class="col-sm-12 my-4">
            <button class="btn btn-primary login_account" type="submit" name="send" value="Log Me In" style="width:100%;">Login</button>
          </div>
        </div>
