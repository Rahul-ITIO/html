	...
	<?  if(isset($post['multiple_subadmin_ids'])&&is_array($post['multiple_subadmin_ids'])) $post['multiple_subadmin_ids'] = implode(',',$post['multiple_subadmin_ids']); ?>
        ...
        <div class="col-sm-12 row my-2 p-0">
          <div class="col-sm-4 pe-0">
            <div><span class="input-group-text" style="height:50px;">Gateway Partners
                <? if(isset($post['multiple_subadmin_ids'])) echo $post['multiple_subadmin_ids']?></span></div>
          </div>
          <div class="col-sm-8 pe-0">
            <select id="multiple_subadmin_ids" data-placeholder="Type gateway initials to select Gateway partner" multiple
              class="chosen-select form-select" name="multiple_subadmin_ids[]">
      ...
      <!-- Dev Tech: 24-12-31 Account manager ID assing by Admin only	-->
        ...
        <div class="col-sm-12 row my-2 p-0">
            <div class="col-sm-4 pe-0">
              <div><span class="input-group-text" style="height:50px;"><label for="account_manager_id">Account Manager ID</label></span></div>
            </div>
            <div class="col-sm-8 pe-0">
                <div style="border:1px solid #dee2e6;border-radius:6px;padding:6px 10px;">
