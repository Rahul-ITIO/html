...
.cnt .navbar  { box-shadow:unset !important; -webkit-box-shadow:unset !important; }
...
<div class="container border my-1 vkg rounded">
	...
	<? if ((isset($data['Error'])&& $data['Error']) && (!$post['change2way'])){?>
		...
		<? if($data['MYWEBSITE']||$_REQUEST['a']){?>	
			...
			<a href="<?=$data['Host']?>/plugins/indcashless-woocommerce-plugin.zip" target="_blank" title="WP Plugins Download">indcashless-woocommerce-plugin.zip</a> <br/>
        ...
        title="WP Plugins Download for <?=$data['Host']?> | paysystem-woocommerce-plugin.zip">paysystem-woocommerce-plugin.zip</a> 
			...
			<a href="<?=$data['Host']?>/plugins/indcashless-whmcs.zip" target="_blank" title="WHMCS Download">indcashless-whmcs.zip</a> <br/>
			...
			<a href="<?=$data['Host']?>/plugins/IndcashlessPrestaShop.zip" target="_blank" title="PrestaShop 1.7 Download">IndcashlessPrestaShop.zip</a>
	
		<? }?>
	<hr/>
	<h3>Pay via @user with Amount:</h3> 
	<a class="nopopup  mt-2 mb-3 cursor-pointer" onclick="ctcf('#paymeId','href','1')" style="cursor:pointer;"><i class="<?=$data['fwicon']['copy'];?>"></i></a>
	...
	if(isset($_SESSION['login_adm']))
	{
		...
		<h4>Domain List</h4>
			...
			?>
				<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" onclick="ctcf('#domainId_<?=$i?>','href')" style="cursor:pointer;"><i class="<?=$data['fwicon']['copy'];?>"></i></a> <a id="domainId_<?=$i?>" href="<?=$data['Prot']?>://<?=$value['domain_name']?>/signins/login<?=$data['ex'];?>" target="_blank"><?=$value['domain_name']?></a> | 
				<? 
	...
	<hr/>
		...
		<h4>Status update  </h4>
			<ul class="list-group">
				<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" href="<?=$data['Admins'];?>/evok_78_success_batch_update_via_ajax<?=$data['ex']?>" target="_blank" style="cursor:pointer;">Evok - Status successfull update via CSV File via Ajax  </a> </li>
				<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" href="<?=$data['Admins'];?>/evok_78_success_batch_update<?=$data['ex']?>" target="_blank" style="cursor:pointer;">Evok - Status successfull update via CSV File </a> </li>
				<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" href="<?=$data['Admins'];?>/cron_transid<?=$data['ex']?>" target="_blank" style="cursor:pointer;">Status Update via TransID</a>  </li>
			</ul>
		</div>
	...
	<hr/>
		...
		<h4>VPA </h4>
			<ul class="list-group">
			<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" href="<?=$data['Admins'];?>/fino_vpa<?=$data['ex']?>" target="_blank" style="cursor:pointer;">Generate VPA via FINO Bank </a></li>
			<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" href="<?=$data['Admins'];?>/canara_vpa<?=$data['ex']?>" target="_blank" style="cursor:pointer;">Generate VPA via Canara Bank </a></li>
			<li class="list-group-item" style="list-style:none;"><a class="nopopup  mt-2 mb-3 cursor-pointer" href="https://can-webhook.web1.one/cron_token_canara<?=$data['ex']?>" target="_blank" style="cursor:pointer;">Refresh Token via Canara Bank </a></li>
...
<hr/>
	...
	<a href="<?=$data['Host'];?>/include/all_merchant_wise_update_available_balance_2<?=$data['ex']?>?a=u&link1=1" target="_blank" title="Manually All merchant wise update available balance">All merchant wise update available balance</a> 
	
<hr/>	
<h3>Crons Manual for Update Status  </h3> 
	<a href="<?=$data['Host'];?>/crons<?=$data['ex']?>?day=10&day2=1" target="_blank" title="Crons Manual for Update Status">Crons Manual for Update Status</a> 
	
<hr/>	
<h3>Crons Manual for expire of pending transitions  </h3> 
	<a href="<?=$data['Host'];?>/crons_expired<?=$data['ex']?>?up1=30&li=20" target="_blank" title="Crons Manual for expire of pending transitions">Crons Manual for expire of pending transitions</a> 
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown"><a class="nav-link " href="javascript:void(0)" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</a>
...
<?php /*?> Dev Tech : 23-02-10 getting dynamic value for use dynamic color code & variable <?php */?>
	...
	<div class="container my-8">
		...
		<table class="table table-striped">
			...
			<a href="<?=$ic9?>" class="img-fluid" target="_blank"><img src="<?=$ic9?>" style="height:30px;padding-right: 10px;"></a>
			</td><td class="click_icon" title="click to copy" style="vertical-align:middle;"><code><pre style="margin:inherit;font-size:14px;">$data['url-image']['<?=$ic9k?>']</pre></code></td><td class="click_icon" title="click to copy" style="vertical-align:middle;"><?=$ic9?></td></tr><? }} ?>
		</table>
	</div>
  ...
  <? */ ?>
	...
	<div class="container mt-3">
		...
		<table class="table">
			<thead >
				<tr><th class="">Color Code</th><th class="">Color</th></tr>
			</thead>
			<tbody>
