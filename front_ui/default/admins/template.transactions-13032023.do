...
/////////////// post_Withdraw - start (Function for send request as per MID - Rajnesh
...
if(((isset($_SESSION['login_adm']))||(isset($_SESSION['transaction_payout_manual'])&&$_SESSION['transaction_payout_manual']==1))&&($transaction_payout_manual)){?>
              ...
              <thead>
                <tr>
				  ...
				  <th scope="col"  class="text-start">
                    ...
                    <a class="trPaymentId text-link" href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? }?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=id" title="Transaction / Payment Id" data-bs-toggle="tooltip" data-bs-placement="top">Payment&nbsp;ID</a> 
                  ...
                  <th scope="col"><a title="Merchant Order Id" data-bs-toggle="tooltip" data-bs-placement="top" href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=mrid" class="text-link">M.&nbsp;Order&nbsp;ID</a></th>
                  <? }?>
                  <? if(in_array("names",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_names'])&&$_SESSION['tr_names']==1))){?>
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=names" class="text-link" title="Customer Name" data-bs-toggle="tooltip" data-bs-placement="top">Customer&nbsp;Name</a></th>
                  <? }?>
                  ...
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=amount" class="text-link" title="Order Amount" data-bs-toggle="tooltip" data-bs-placement="top">Order&nbsp;Amount</a></th>
                  <? }?>
                  ...
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=transaction_amt" class="text-link" title="Transaction Amount" data-bs-toggle="tooltip" data-bs-placement="top">Trans.&nbsp;Amount</a></th>
                  <? }?>
                  ...
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=available_balance" title="Balance Amount" data-bs-toggle="tooltip" data-bs-placement="top" class="text-link">Balance</a></th>
                  <? }?>
                  <? if(in_array("tdate",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_tdate'])&&$_SESSION['tr_tdate']==1))){?>
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=tdate" class="text-link" title="Transaction Date Time" data-bs-toggle="tooltip" data-bs-placement="top">Timestamp </a></th>
                  <? }?>
                  ...
                  <? if($post['type']<0){?>
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=type" class="text-link">Acquirer</a></th>
                  <? }?>
                  <? }?>
                  <? }?>
                  ...
                  <? if($post['status']<0){?>
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=status" class="text-link">Status</a></th>
                  <? }?>
                  <? }?>
                  ...
                  <th scope="col"><a href="<?=$data['Admins']?>/transactions<?=$data['ex']?>?<? if(isset($post['bid']) && $post['bid']){?>bid=<?=$post['bid']?>&<? } ?>page=<?=$curr_pg?>&type=<?=$post['type']?>&status=<?=$post['status']?>&action=select&order=receiver" class="text-link">Receiver</a></th>
                  <? }?>
                  ...
                  <th scope="col" title="Website ID" data-bs-toggle="tooltip" data-bs-placement="top">Website&nbsp;ID</th>
                  <? }?>
                  ...
                  <? }?>
                  <? if(in_array("remark",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_remark'])&&$_SESSION['tr_remark']==1))){?>
                  ...
                  <th scope="col" title="Notify Url" data-bs-toggle="tooltip" data-bs-placement="top">Notify&nbsp;Url</th>
                  <? }?>
                  ...
                  <th scope="col" title="Success Url" data-bs-toggle="tooltip" data-bs-placement="top">Success&nbsp;Url</th>
                  <? }?>
                  ...
                  <th scope="col" title="Failed Url" data-bs-toggle="tooltip" data-bs-placement="top">Failed&nbsp;Url</th>
                  <? }?>
  ...
  <? 
						...
						if($value['typenum']==2){
							if($value['ostatus']==13){
								if(isset($txn_value_array['coins_network'])&&$txn_value_array['coins_network'])	//CHECK WITHDRAW REQUEST IS FOR Crypto Wallet or not - RAJNESH
								{
								?>
  ...
  <?
								...
								{
									//FETCH ALL AVAILABLE ACTIVE BANK LIST IN CASH OF BANK NODAL - RAJNESH
									$result_select=db_rows(
										" SELECT * FROM {$data['DbPrefix']}bank_table".
										" WHERE bg_active='1' AND account_type='6'".
										" ORDER BY id DESC"
									);
									...
									{
										$acquirer_json	= json_decode($b_val['acquirer_json'],1);
										$bank_json		= json_decode(decode_f($b_val['bank_json']),1);

										//CHECK AVAILABLE PAYMENT METHOD IF EXISTS - RAJNESH
										if(isset($bank_json['method'])&&$bank_json['method']) {
											//$post_method = explode(",",$bank_json['method']);
											$post_method = $bank_json['method'];
											?>
  <li class='g_validate 17'><a class="hrefmodal mt-2 ms-1 text-decoration-none" style="white-space:nowrap;" data-tid="<?=$value['transaction_id']?>" data-href="<?=($data['Host']."/include/post_method".$data['ex']."?id=".$b_val['id']."&account_no=".$b_val['account_no']."&transaction_id=".$value['transaction_id']."&tid=".$value['id']."&uid=".((isset($post['bid'])&&$post['bid']>0)?$post['bid']:$value['receiver'])."&bid=".((isset($post['bid'])&&$post['bid']>0)?$post['bid']:$value['receiver'])).(isset($post_method)?"&post_method={$post_method}":"");?>&order_amt=<?=$value['amount']?>&checkout_level_name=<?=$acquirer_json['checkout_level_name'];?>&action=details&admin=1&tempui=<?=$data['frontUiName']?>" title="<?=$value['transaction_id'];?>"> <i class="<?=$data['fwicon']['bank'];?>"></i>
    <?=$acquirer_json['checkout_level_name'];?>
    Post</a></li>
  <?
											}
										else
										{
										//IF PAYMENT METHOD NOT AVAILABLE THEN NORMAL NODAL POST - RAJNESH
										?>
  <li class='g_validate 18'><a data-mhoid="<?=$value['transaction_id'];?>_<?=$value['id'];?>" data-type="<?=$b_val['account_no'];?>" onClick="post_Withdraw(this);" class="hkip_status_id dropdown-item" title="<?=$acquirer_json['checkout_level_name'];?> Post"><i class="<?=$data['fwicon']['bank'];?>"></i>
    <?=$acquirer_json['checkout_level_name'];?>
    Post</a></li>
  <?
										}
  ...
  <? }?>
  <? 
						//IF STATUS=1 THEN DON'T CANCEL, SO COMMENT ['ostatus']==1 -- RAJNESH
  ...
  <? }?>
  <? 
						//TEST TRANSACTION NOT ACTIVE IN CASE OF WITHDRAW - $value['typenum']!=2 CONDITION SET BY RAJNESH
  ...
  <? }?>
                ...
                <? }?>
                <? }?>
                <? if(in_array("mrid",$_SESSION['transaction_display_arr'])){?>
                <td align="center"><div title="<?=$value['mrid']?>" data-bs-toggle="tooltip" data-bs-placement="top" style="width:90px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">
                    <?=$value['mrid']?>
                  </div></td>
                <? }?>
                <? if(in_array("names",$_SESSION['transaction_display_arr'])){?>
                <td align="center" title="Full Name: <?=prntext($value['names']);?>" data-bs-toggle="tooltip" data-bs-placement="top" nowrap><?=prntext(lf($value['names'],15,1));?>                </td>
                <? }?>
                <? if(in_array("amount",$_SESSION['transaction_display_arr'])){?>
                <td align="center" class="pricecolor" nowrap><?=$value['amount']?></td>
                <? }?>
                <? if(in_array("transaction_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_transaction_amt'])&&$_SESSION['tr_transaction_amt']==1))){?>
                <td align="center" class="pricecolor" nowrap><?=$value['transaction_amt']?></td>
                <? }?>
                <? if(in_array("available_balance",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_available_balance'])&&$_SESSION['tr_available_balance']==1))){?>
	  ...
	  if($img=="nocc.png"){ $fwimg=1; $fwicon=$data['fwicon']['nocc']; }
	   ...
	   ?>
                ...
                <? }?>
                <? if(in_array("reason",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_reason'])&&$_SESSION['tr_reason']==1))){?>
                <td align="center"><div title="<?=$value['reason']?>" data-bs-toggle="tooltip" data-bs-placement="top" style="width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                ...
                <? if((isset($_SESSION['login_adm']))||(isset($_SESSION['t_acquirer_view'])&&$_SESSION['t_acquirer_view']==1)){?>
                <? if($post['type']<0){?>
                <td align="center" nowrap><?=$value['type']?></td>
                <? }?>
                <? }?>
                <? }?>
                <? if(in_array("status",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_status'])&&$_SESSION['tr_status']==1))){?>
                ...
                <? }?>
                <? if(in_array("ip",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_ip'])&&$_SESSION['tr_ip']==1))){?>
                <td align="center" nowrap><a onclick="iframe_open_modal(this);" class="dotdot nomid" data-ihref='<?=$data['Host'];?>/include/ips<?=$data['ex']?>?remote=<?=$value['ip']?>' title='IP: <?=prntext($value['ip']);?>' data-bs-toggle="tooltip" data-bs-placement="top">
                  <?=prntext(lf($value['ip'],15,1));?>
                  </a></td>
                <? }?>
                <? if(in_array("store_id",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_store_id'])&&$_SESSION['tr_store_id']==1))){?>
                <td align="center" nowrap><?=$value['store_id']?></td>
                <? }?>
                <? if(in_array("txn_id",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_txn_id'])&&$_SESSION['tr_txn_id']==1))){?>
                <td align="center" nowrap title="RefNo ID of Bank Response" ><?=$value['txn_id']?></td>
                <? }?>
                <? if(in_array("txn_value",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_txn_value'])&&$_SESSION['tr_txn_value']==1))){?>
                <td nowrap align="center" title="<?=encryptres($value['txn_value']);?>" data-label="Bank Response" data-bs-toggle="tooltip" data-bs-placement="top"><a  class="dotdot nomid text-link modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?json=<?=encryptres($value['txn_value']);?>' >
                  <?=prntext(lf($value['txn_value'],15,1));?>
                  </a></td>
                <? }?>
                <? if(in_array("json_value",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_json_value'])&&$_SESSION['tr_json_value']==1))){?>
                <td nowrap align="center" title="<?=encryptres($value['json_value']);?>" data-label="Post Josn" data-bs-toggle="tooltip" data-bs-placement="top"><a class="dotdot nomid text-link modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?json=<?=encryptres($value['json_value']);?>' >
                  <?=prntext(lf($value['json_value'],15,1));?>
                </a></td>
                <? }?>
                <? if(in_array("remark",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_remark'])&&$_SESSION['tr_remark']==1))){?>
                <td align="center" title='<?=prntext($value['remark']);?>'><a onclick="iframe_open_modal(this);" class="dotdot nomid text-link" data-ihref='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?json=<?=encryptres($value['remark']);?>' style="height:20px;" >
                  <?=prntext($value['remark']);?>
                  </a></td>
                <? }?>
                <? if(in_array("reply_remark",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_reply_remark'])&&$_SESSION['tr_reply_remark']==1))){?>
                <td align="center" nowrap><a onclick="iframe_open_modal(this);" class="dotdot nomid text-link" data-ihref='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['reply_remark']);?>' style="height:20px;" >Note Support</a></td>
                <? }?>
                <? if(in_array("system_note",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_system_note'])&&$_SESSION['tr_system_note']==1))){?>
                ...
                <? }?>
                <? if(in_array("notify_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_notify_url'])&&$_SESSION['tr_notify_url']==1))){?>
                <td align="center" nowrap title="Notify Url: <?=prntext($value['notify_url']);?>" data-label="Notify Url"  data-bs-toggle="tooltip" data-bs-placement="top"><a class="dotdot nomid text-link modal_for_iframe" ihref='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['notify_url']);?>' style="height:20px;overflow:hidden;" >
                  <?=prntext(lf($value['notify_url'],15,1));?>
                  </a></td>
                <? }?>
                <? if(in_array("success_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_success_url'])&&$_SESSION['tr_success_url']==1))){?>
                <td align="center" nowrap title="Success Url: <?=prntext($value['success_url']);?>" data-label="Success Url"  data-bs-toggle="tooltip" data-bs-placement="top"><a class="dotdot nomid text-link modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['success_url']);?>' style="height:20px;overflow:hidden;" >
                  <?=prntext(lf($value['success_url'],15,1));?>
                  </a></td>
                <? }?>
                <? if(in_array("failed_url",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_failed_url'])&&$_SESSION['tr_failed_url']==1))){?>
                <td align="center" nowrap title="Failed Url: <?=prntext($value['failed_url']);?>" data-label="Failed Url"   data-bs-toggle="tooltip" data-bs-placement="top"><a class="dotdot nomid text-link modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?strip=skip&json=<?=encryptres($value['failed_url']);?>' style="height:20px;overflow:hidden;" >
                  <?=prntext(lf($value['failed_url'],15,1));?>
                  </a></td>
                <? }?>
                <? if(in_array("mdr_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_amt'])&&$_SESSION['tr_mdr_amt']==1))){?>
                <td align="center" nowrap title="<?=$value['mdr_amt']?>" data-bs-toggle="tooltip" data-bs-placement="top" ><?=$value['mdr_amt'];?></td>
                <? }?>
                <? if(in_array("gst_fee",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_gst_fee'])&&$_SESSION['tr_gst_fee']==1))&&($data['con_name']=='clk')){?>
                <td align="center" nowrap title="GST Fee : <?=$value['gst_fee'];?>" data-label="GST Fee" data-bs-toggle="tooltip" data-bs-placement="top"><?=$value['gst_fee'];?></td>
                <? }?>
				<? if(in_array("rrn",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_rrn'])&&$_SESSION['tr_rrn']==1))){?>
                <td align="center" nowrap title="RRN : <?=$value['rrn'];?>" data-label="RRN" data-bs-toggle="tooltip" data-bs-placement="top"><?=$value['rrn'];?></td>
                <? }?>
                <? if(in_array("mdr_txtfee_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_mdr_txtfee_amt'])&&$_SESSION['tr_mdr_txtfee_amt']==1))){?>
                <td align="center" nowrap title="Transaction Fee : <?=remove_string($value['mdr_txtfee_amt']);?>" data-label="Transaction Fee " data-bs-toggle="tooltip" data-bs-placement="top"><?=$value['mdr_txtfee_amt'];?></td>
                <? }?>
                <? if(in_array("rolling_amt",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_rolling_amt'])&&$_SESSION['tr_rolling_amt']==1))){?>
                ...
                <? }?>
                <? if(in_array("payout_date",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_payout_date'])&&$_SESSION['tr_payout_date']==1))){?>
                <td align="center" title="Payout Date : <?=prndate($value['payout_date']);?>" data-label="Payout Date" data-bs-toggle="tooltip" data-bs-placement="top"><?=prndate($value['payout_date']);?></td>
                <? }?>
                <? if(in_array("created_date",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_created_date'])&&$_SESSION['tr_created_date']==1))){?>
                ...
                <? }?>
                <? if(in_array("currname",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_currname'])&&$_SESSION['tr_currname']==1))){?>
                <td align="center" nowrap title="Order Currency : <?=$value['currname'];?>" data-label="Order Currency" data-bs-toggle="tooltip" data-bs-placement="top"><?=$value['currname'];?> </td>
                <? }?>
                <? if(in_array("orderset",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_orderset'])&&$_SESSION['tr_orderset']==1))){?>
                ...
                <? } ?>
                <? if(in_array("trname",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_trname'])&&$_SESSION['tr_trname']==1))){?>
                <td align="center" nowrap title="CN/CH/WD : <?=$value['trname'];?>" data-label="CN/CH/WD"  data-bs-toggle="tooltip" data-bs-placement="top"><?=$value['trname'];?></td>
                <? }?>
                <? if(in_array("email_add",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_email_add'])&&$_SESSION['tr_email_add']==1))){?>
                <td align="center" nowrap title="Email : <?=prntext($value['email_add']);?>" data-label="Email" data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext($value['email_add']);?></td>
                <? }?>
                <? if(in_array("phone_no",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_phone_no'])&&$_SESSION['tr_phone_no']==1))){?>
                <td align="center" nowrap title="Phone No. : <?=prntext($value['phone_no']);?>" data-label="Phone No."  data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext($value['phone_no']);?></td>
                <? }?>
                <? if(in_array("product_name",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_product_name'])&&$_SESSION['tr_product_name']==1))){?>
                ...
                <? }?>
                <? if(in_array("address",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_address'])&&$_SESSION['tr_address']==1))){?>
                <td align="center" nowrap title="Address: <?=prntext($value['address']);?>" data-label="Address"><a class="dotdot nomid modal_for_iframe" href='<?=$data['Admins'];?>/json_pretty_print<?=$data['ex']?>?json=<?=encryptres($value['address']);?>' data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext(lf($value['address'],15,1));?></a></td>
                <? }?>
                <? if(in_array("city",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_city'])&&$_SESSION['tr_city']==1))){?>
                <td align="center" nowrap title="City : <?=prntext($value['city']);?>" data-label="City" data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext($value['city']);?></td>
                <? }?>
                <? if(in_array("state",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_state'])&&$_SESSION['tr_state']==1))){?>
                <td align="center" nowrap title="State : <?=prntext($value['state']);?>" data-label="State" data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext($value['state']);?></td>
                <? }?>
                <? if(in_array("country",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_country'])&&$_SESSION['tr_country']==1))){?>
                <td align="center" nowrap title="Country : <?=prntext($value['country']);?>" data-label="Country" data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext($value['country']);?></td>
                <? }?>
                <? if(in_array("zip",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_zip'])&&$_SESSION['tr_zip']==1))){?>
                <td align="center" nowrap title="Zip Code : <?=prntext($value['zip']);?>" data-label="Zip Code" data-bs-toggle="tooltip" data-bs-placement="top"><?=prntext($value['zip']);?></td>
                <? }?>
                <? if(in_array("descriptor",$_SESSION['transaction_display_arr'])&&((isset($_SESSION['login_adm']))||(isset($_SESSION['tr_descriptor'])&&$_SESSION['tr_descriptor']==1))){?>
