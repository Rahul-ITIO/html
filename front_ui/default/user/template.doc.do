...
<title><?=$data['SiteName'];?> API Documentation 1.0.3 Indian</title>
<head>
<meta charset="utf-8" />
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
  <div class="sidenav-header text-white active bg-gradient-info"> <i class="<?=$data['fwicon']['delete'];?> p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i> <a class="navbar-brand m-0" target="_blank"><span class="ms-1 font-weight-bold text-white">Menu - Developer Guide</span></a> </div>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main menu-center" style="height: auto !important;" >
    <ul class="navbar-nav" >
      <li class="nav-item"  data-unique="document_illustration"> <a class="nav-link px-0 align-middle text-white" href="#document_illustration"> <span class="nav-link-text ms-1"> Document Illustration 1.0.4</span></a> </li>
      <li class="nav-item"  data-unique="preparation"> <a class="nav-link px-0 align-middle text-white" href="#preparation"> <span class="nav-link-text ms-1"> Preparation</span></a> </li>
      <li class="nav-item"  data-unique="card_payment_gateway_curl_direct"> <a class="nav-link px-0 align-middle text-white" href="#card_payment_gateway_curl_direct"> <span class="nav-link-text ms-1"> Card Payment Gateway</span></a> </li>
      <li class="nav-item"  data-unique="card_payment_gateway_redirect_host"> <a class="nav-link px-0 align-middle text-white" href="#card_payment_gateway_redirect_host"> <span class="nav-link-text ms-1"> Payment Gateway</span></a> </li>
      <li class="nav-item"  data-unique="encrypted_card_payment_gateway_redirect_host"> <a class="nav-link px-0 align-middle text-white" href="#encrypted_card_payment_gateway_redirect_host"> <span class="nav-link-text ms-1"> Encrypted Payment Gateway</span></a> </li>
      <?php /*?><li class="nav-item"  data-unique="encrypted_card_payment_curl_direct"> <a class="nav-link px-0 align-middle text-white" href="#encrypted_card_payment_curl_direct"> <span class="nav-link-text ms-1"> Encrypted Payment Gateway (Curl-Direct)</span></a> </li><?php */?>
	 
	  
      <li class="nav-item"  data-unique="card_payment_gateway_redirect_sdk"> <a class="nav-link px-0 align-middle text-white" href="#card_payment_gateway_redirect_sdk"> <span class="nav-link-text ms-1"> Card Payment Gateway (SDK)</span></a> </li>
	  
	   <?php /*?><li class="nav-item"  data-unique="encrypted_payout_payment_curl_direct"> <a class="nav-link px-0 align-middle text-white" href="#encrypted_payout_payment_curl_direct"> <span class="nav-link-text ms-1"> Encrypted Payout Payment Gateway (Curl-Direct)</span></a> </li><?php */?>
	   
	   
      <li class="nav-item"  data-unique="notify_callbacks"> <a class="nav-link px-0 align-middle text-white" href="#notify_callbacks"> <span class="nav-link-text ms-1"> Notify / Callbacks</span></a> </li>
      <li class="nav-item"  data-unique="transaction_status"> <a class="nav-link px-0 align-middle text-white" href="#transaction_status"> <span class="nav-link-text ms-1"> Transaction Status</span></a> </li>
      <li class="nav-item"  data-unique="refund_order_request"> <a class="nav-link px-0 align-middle text-white" href="#refund_order_request"> <span class="nav-link-text ms-1"> Refund Order Request</span></a> </li>
      <li class="nav-item"  data-unique="test_card_number"> <a class="nav-link px-0 align-middle text-white" href="#test_card_number"> <span class="nav-link-text ms-1"> Test Card Number</span></a> </li>
      <li class="nav-item"  data-unique="error_code"> <a class="nav-link px-0 align-middle text-white" href="#error_code"> <span class="nav-link-text ms-1"> Error Code</span></a> </li>
      <li class="nav-item"  data-unique="integration_faq"> <a class="nav-link px-0 align-middle text-white" href="#integration_faq"> <span class="nav-link-text ms-1"> Integration FAQ</span></a> </li>
      <li class="nav-item"  data-unique="shopping_cart_plugins"> <a class="nav-link px-0 align-middle text-white" href="#shopping_cart_plugins"> <span class="nav-link-text ms-1"> Shopping Cart Plugins</span></a> </li>
      <li class="nav-item"  data-unique="cards"> <a class="nav-link px-0 align-middle text-white" href="#cards"> <span class="nav-link-text ms-1"> Card</span></a> </li>
      <?php /*?><li class="nav-item"  data-unique="currency_support"> <a class="nav-link px-0 align-middle text-white" href="#currency_support"> <span class="nav-link-text ms-1"> Currency Support</span></a> </li><?php */?>
      <li class="nav-item"  data-unique="order_status_illustration"> <a class="nav-link px-0 align-middle text-white" href="#order_status_illustration"> <span class="nav-link-text ms-1"> Appendix: Order status illustration</span></a> </li>
      <?php /*?><li class="nav-item" data-unique="country_code_illustration"> <a class="nav-link px-0 align-middle text-white" href="#country_code_illustration"> <span class="nav-link-text ms-1"> Appendix: Country Code</span></a> </li><?php */?>
      <?php /*?><li class="nav-item"  data-unique="state_code_illustration"> <a class="nav-link px-0 align-middle text-white" href="#state_code_illustration"> <span class="nav-link-text ms-1"> Appendix: State Code</span></a> </li><?php */?>
    </ul>
  </div>
</aside>
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <h6 class="font-weight-bolder mb-0">Developer Guide</h6>
      </nav>
  ...
  <div class="container-fluid py-4">
    <!--============1===========-->
    <div class="row" id="document_illustration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><strong>curr</strong>
                        <div class="method-details"><span class="blue_r">str</span> <span class="blue_r"><abbr title="curr (e.g. INR) From Merchant ">M</abbr></span></div>
                        <div class="method-badge">required</div></td>
        ...
        <div class="card h-100 mb-4 bg-gradient-dark">
          <div class="card-body pt-4 p-3">
            <blockquote> Example of Card Payment Gateway: 
				...
				<a class="blue_r coppy" onClick="ctcf('#code_3_pre');"><i class="<?=$data['fwicon']['copy'];?>"></i> Coppy</a>
			</blockquote>
...
<span class="k">$curlPost["</span><span class="s1">curr</span><span class="k">"]</span><span class="k">="</span><span class="nf">INR</span><span class="k">"</span><span class="cp">;</span>
...
<span class="k">$curlPost["</span><span class="s1">bill_street_1</span><span class="k">"]</span><span class="k">="</span><span class="nf">A97B North Block</span><span class="k">"</span><span class="cp">;</span>
<span class="k">$curlPost["</span><span class="s1">bill_street_2</span><span class="k">"]</span><span class="k">="</span><span class="nf">West Vinod Nagar</span><span class="k">"</span><span class="cp">;</span>
<span class="k">$curlPost["</span><span class="s1">bill_city</span><span class="k">"]</span><span class="k">="</span><span class="nf">New Delhi</span><span class="k">"</span><span class="cp">;</span>
<span class="k">$curlPost["</span><span class="s1">bill_state</span><span class="k">"]</span><span class="k">="</span><span class="nf">DL</span><span class="k">"</span><span class="cp">;</span>
<span class="k">$curlPost["</span><span class="s1">bill_country</span><span class="k">"]</span><span class="k">="</span><span class="nf">IN</span><span class="k">"</span><span class="cp">;</span>
<span class="k">$curlPost["</span><span class="s1">bill_zip</span><span class="k">"]</span><span class="k">="</span><span class="nf">110092</span><span class="k">"</span><span class="cp">;</span>
<span class="k">$curlPost["</span><span class="s1">bill_phone</span><span class="k">"]</span><span class="k">="</span><span class="nf">9555500070</span><span class="k">"</span><span class="cp">;</span>
        ...
        <div id="code_4" class="card h-100 mb-4 bg-gradient-dark">
          <div class="card-body pt-4 p-3">
            <blockquote  > Example of Card Payment Gateway: 
				...
				<a class="blue_r coppy" onClick="ctcf('#code_4_pre');"><i class="<?=$data['fwicon']['copy'];?>"></i> Coppy</a>
			</blockquote>
        ...
        <div class="card h-100 mb-4 bg-gradient-dark">
          <div class="card-body pt-4 p-3">
			...
			<a class="blue_r fullscreen" onClick="toggle_fullscreen(this,'#code_5');"><i class="<?=$data['fwicon']['desktop'];?>"></i> <span>Full Sreen</span></a>
				<a class="blue_r coppy" onClick="ctcf('#code_5_pre');"><i class="<?=$data['fwicon']['copy'];?>"></i> Coppy</a>
			</blockquote>
...
<span class="cp">?&gt;</span> 
    ...
    <div class="row"  id="card_payment_gateway_redirect_sdk">
      ...
      <div id="code_7" class="col-md-5 mt-4 bg-gradient-dark card">
        <div class="card h-100 mb-4 bg-gradient-dark">
          <div class="card-body pt-4 p-3">
			...
			<a class="blue_r fullscreen" onClick="toggle_fullscreen(this,'#code_7');"><i class="<?=$data['fwicon']['desktop'];?>"></i> <span>Full Sreen</span></a>
				<a class="blue_r coppy" onClick="ctcf('#code_7_pre');"><i class="<?=$data['fwicon']['copy'];?>"></i> Coppy</a>
			</blockquote>
