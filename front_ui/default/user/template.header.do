   ...
   ?>
        ...
        <li class="nav-item dropdown"> <a class="nav-link text-white dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Transactions </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <? } ?>
            <? if((isset($post['settlement_optimizer'])&&trim($post['settlement_optimizer'])&&$post['settlement_optimizer']=='manually')||(isset($_SESSION['m_settlement_optimizer'])&&(strtolower($_SESSION['m_settlement_optimizer'])=='custom'||strtolower($_SESSION['m_settlement_optimizer'])=='weekly')&&isset($data['CUSTOM_SETTLEMENT_WD_V3'])&&$data['CUSTOM_SETTLEMENT_WD_V3']=='Y')){ if(((in_array(16, $grole)) && ($_SESSION['m_clients_type']=='Sub Member')) || ($_SESSION['m_clients_type']=='')){ ?>
