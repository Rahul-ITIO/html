...
if((isset($post['fullname'])&&$post['fullname']) && (isset($post['company_name'])&&$post['company_name']) && (isset($post['registered_address'])&&$post['registered_address'])){
...
<div id="zink_id" class="container mt-2 mb-2 rounded border bg-primary text-white vkg" >
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <a href="<?=$data['USER_FOLDER']?>/bank<?=$data['ex']?>?HideAllMenu=1&action=addNewBank_1" title="Add your bank account" class="text-link  modal_for_iframe"><i class="<?=$data['fwicon']['circle-dot'];?>"></i> Bank Account</a> <br />
        <a href="<?=$data['USER_FOLDER']?>/bank<?=$data['ex']?>?HideAllMenu=1&action=addCryptoWallet_2" title="Add your crypto wallet" class="text-link modal_for_iframe"><i class="<?=$data['fwicon']['circle-dot'];?>"></i> Crypto Wallet</a> <br />
   ...
   <? if((isset($data['Error'])&& $data['Error'])){ ?>
	...
	<? } ?>
	 ...
	 <div class="row vkg hide_all_div show_d3">
		<div class="row py-1 rounded was-validated">
			<?
				$spoc_view_1=spoc_view(@$_SESSION['uid'],0,1);
				//print_r($spoc_view_1); echo "<div class=row> </div><br/>";
				if(isset($_REQUEST['dtest'])) print_r(@$spoc_view_1);
			?>
			<div class="mb-2 fs-5 hide-title">Add more your spoc information</div>
			...
			<span>Fill details to help us in understanding your business better and meet the requirements of regulators, financial partners and our Services Agreement.</span>
				...
				<div class="col-sm-12">
				<div class="input-field mt-4">
					<input type="text" id="spoc_fname" name="fullname" class="form-control form-control-sm"  value="<?=@$spoc_view_1['fullname']?>" required data-bs-toggle="tooltip" data-bs-placement="right" title="Enter spoc name">
				...
				<div class="input-field mt-4">
					...
					<input type="text" id="spoc_designation" name="designation" class="form-control form-control-sm"  value="<?=@$spoc_view_1['designation']?>" required="" data-bs-toggle="tooltip" data-bs-placement="right" title="Enter spoc designation">
				...
				<div class="col-sm-12">
				<div class="input-field mt-4">
					<input type="text" id="spoc_phone" name="phone" class="form-control form-control-sm" value="<?=@$spoc_view_1['phone']?>" required="" data-bs-toggle="tooltip" data-bs-placement="right" title="Enter spoc contact number">
		  ...
		  <div class="input-field select mt-4">
			...
			<? 
			//if(isset($spoc_view_1['ims_type']))
			{?>
           <script>
			$('#ims_type option[value="<?=(@$spoc_view_1['ims_type'])?>"]').prop('selected','selected');
		   </script>
		   <? } 
			...
			<div class="col-sm-8">
			<div class="input-field mt-4">
			<input type="text" id="spoc_email" name="email" value="<?=stf(@$spoc_view_1['email'])?>"  class="form-control" data-bs-toggle="tooltip" data-bs-placement="right" title="Enter IM'S id" required />
		...
		<div class="card-body">
				...
				<div class="col-sm-8 text-start">: <?=@$spoc_view_1['email']?></div>
			 	...
			 	<?
					$spoc_view_12=spoc_view(@$_SESSION['uid'],0,0);
					//print_r($spoc_view_1); echo "<div class=row> </div><br/>";
				?>
