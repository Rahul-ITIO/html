        ...
        <tbody>
          ...
          <tr>
            ...
            <td title="Action" >
			  ...
			  <a class="hrefmodal" data-href="<?=$data['Host'];?>/transactions_get<?=$data['ex']?>?id=<?=$value['id']?><? if(isset($post['StartPage'])){ ?>&page=<?=$post['StartPage']?><? } ?>&action=details" data-tid="<?=$value['transaction_id']?>"  title="view"  ><i class="<?=$data['fwicon']['eye-solid'];?>"></i></a>
