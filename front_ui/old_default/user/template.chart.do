...
<div class="row border rounded 44 bg-vdark m-2 text-start vkg">		 
    ...
    padding: 5px 20px 5px 20px !important;">15:00</div>
		...
		<? /*?>
		<img class="qr_code" src="https://quickchart.io/chart?chs=250x250&chld=L|0&cht=qr&chl=bitcoin:<?php echo $_SESSION['r_coins']['bitcoinAddress'];?>?&amount=<?php echo $_SESSION['r_coins']['bitcoinAmount'];?>" />
		<?*/?>
