  ...
  <ul class="list-unstyled components position-fixed invisible-scrollbar" style="height:calc(100% - 80px);overflow:hidden;overflow-y:auto;float:left;width:177px;">
   ...
   ?>
    ...
    <li><a class="text-primary-menu text-decoration-none text-white <?=@$activecss_statement;?>" href="<?=$data['USER_FOLDER']?>/statement<?=$data['ex']?>" ><i class="<?=$data['fwicon']['transaction'];?> fa-fw" title="Transaction"></i> <span class="menu_title">Transaction</span></a></li>
      ...
      <li><a class="text-primary-menu text-decoration-none text-white <?=@$activecss_settlement;?>" href="<?=$data['USER_FOLDER']?>/settlement<?=$data['ex']?>"><i class="<?=$data['fwicon']['settlement'];?> fa-fw" title="Settlement"></i><span class="menu_title"> <span class="menu_title">Settlement</span></span></a></li>
      <? } ?>
...
<?/*?>	
<li><a class="text-primary-menu text-decoration-none text-white" href="<?=$data['USER_FOLDER']?>/fino_vpa<?=$data['ex']?>" ><i class="<?=$data['fwicon']['payment_button'];?> fa-fw" title="Generate Fino VPA"></i> <span class="menu_title">Generate Fino VPA</span></a></li>
<?*/?>	
