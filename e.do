...
.btn{ background-color:#009; color:#FFF; padding:15px; margin:20px; width:25%; font-weight:bold; border:1px solid #000;cursor:pointer;font-size:20px;border-radius:6px;}
...
.small{width:auto !important; font-size:15px;margin:0 auto !important; padding:10px !important;height:42px;}
