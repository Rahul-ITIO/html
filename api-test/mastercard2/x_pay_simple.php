        ...
        <table width="60%" align="center" cellpadding="5" border="0">
            ...
            <tr>
             ...
             <tr class="shade">
                 ...
                 <td width="50%"><input type="text" readonly="readonly" name="version" value="41" size="8" maxlength="80" /></td>
             </tr>

             <tr>
                 <td align="right" width="50%"><strong>order.id</strong></td>
                 <td><input type="text" name="orderId" value="<?=date('ymdHisu')?>" size="20" maxlength="60"/></td>
             </tr>

             <tr class="shade">
                  <td align="right" width="50%"><strong>transaction.id</strong></td>
                <td><input type="text" name="transactionId" value="<?=date('ymdHisu')?>" size="20" maxlength="60"/></td>
             </tr>
            ...
            <tr>
             ...
             <tr class="shade">
                 ...
                 <td><input type="text" name="sourceOfFunds[provided][card][number]" value="345678901234564" size="19" maxlength="80"/></td>
             </tr>
             ...
             <tr>
                 ...
                 <td><input type="text" name="sourceOfFunds[provided][card][securityCode]" value="0000" size="8" maxlength="4"/></td>
             </tr>

             <tr class="shade">
                 <td align="right"><strong>order.amount </strong></td>
                 <td><input type="text" name="order[amount]" value="150" size="8" maxlength="13"/></td>
             </tr>

             <tr>
                 <td align="right"><strong>order.currency </strong></td>
                 <td><input type="text" name="order[currency]" value="KES" size="8" maxlength="3"/></td>
             </tr>
