...
<html>
    ...
    <table align="center">
    	<tr>
    		<td height="40" width="25%"><strong><a href="x_authorize_simple.php">Simple Authorize</a></strong><br/>x_authorize_simple.php</td>
    	...
    	<tr>
    		<td height="40" width="25%"><strong><a href="x_pay_simple.php">Simple Pay</a></strong><br/>x_pay_simple.php</td>
    	...
    	<tr>
    		<td height="40" width="25%"><strong><a href="x_capture_simple.php">Simple Capture</a></strong><br/>x_capture_simple.php</td>
    	...
    	<tr>
    		<td height="40" width="25%"><strong><a href="x_refund_simple.php">Simple Refund</a></strong><br/>x_refund_simple.php</td>
		...
		<tr>
    		<td height="40" width="25%"><strong><a href="x_void_simple.php">Simple Void</a></strong><br/>x_void_simple.php</td>
        ...
        <tr>
            <td height="40" width="25%"><strong><a href="x_verify_simple.php">Simple Verify</a></strong><br/>x_verify_simple.php</td>
        ...
        <tr>
            <td height="40" width="25%"><strong><a href="x_initiate_simple.php">Simple Initiate Browser Payment</a></strong><br/>x_initiate_simple.php</td>
        ...
        <tr>
            <td height="40" width="25%"><strong><a href="x_confirm_simple.php">Simple Confirm Browser Payment</a></strong><br/>x_confirm_simple.php</td>
        ...
        <tr>
            <td height="40" width="25%"><strong><a href="x_update_authorization_simple.php">Simple Authorization Update</a></strong><br/>x_update_authorization_simple.php</td>
        ...
        <tr>
            <td height="40" width="25%"><strong><a href="x_retrieve_transaction_simple.php">Simple Retrieve Transaction</a></strong><br/>x_retrieve_transaction_simple.php</td>
		...
		<br/><br/>
		   ...
		   <table width="80%" align="center">
	    	...
	    	<tr>
	    		<td height="40" width="35%"><strong>/index.php</strong></td>
	    	...
	    	<tr>
	    		<td height="40" width="35%"><strong>x_[transaction_type].php</strong></td>
