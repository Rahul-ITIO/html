...
$data['DB_CON']=array(
	1=>array(
		'NAME'=>'PSQL 2024-05-01',
			...
			'db_password'=>'amtDzqG2JZMLyzKta%s9TRpFbkQnm',
			'db_database'=>'livepsqldb33',
		'db_hostname'=>'172.31.28.122', //	 172.31.28.122 || localhost
			'DbPort'=>'5432', // 5432 3306
			'connection_type'=>'PSQL',
		'MORE_ADDITIONAL'=>[
			1=>array(
				'NAME'=>'Previous PSQL 2024-05-01',
				'DATE_TO'=>'2024-05-01',
	...
	2=>array(
		'NAME'=>'Previous PSQL 2024-04-01',
			'db_username'=>'pgslquser',
			'db_password'=>'amtDzqG2JZMLyzKta%s9TRpFbkQnm',
			'db_database'=>'livepsqldb32',
		'db_hostname'=>'172.31.14.133',
			'DbPort'=>'5432', // 5432 3306
			'connection_type'=>'PSQL',
		'MORE_ADDITIONAL'=>[
			1=>array(
	...
	3=>array(
		'NAME'=>'Previous PSQL Transactions',
			'db_username'=>'pgslquser',
			'db_password'=>'amtDzqG2JZMLyzKta%s9TRpFbkQnm',
			'db_database'=>'livepsqldb30',
		'db_hostname'=>'172.31.45.191',
			'DbPort'=>'5432', // 5432 3306
			'connection_type'=>'PSQL',
		'MORE_ADDITIONAL'=>[
			1=>array(
	...
	4=>array(
		'NAME'=>'1. Previous MySql Transactions',
			'db_username'=>'usergwdodbapp2',
			'db_password'=>'@@bueckjHFSK127Ssdj#',
			'db_database'=>'dbnamegwdo31',
		'db_hostname'=>'172.31.41.189',
			'DbPort'=>'3306',
	...
	5=>array(
		'NAME'=>'2. Previous MySql Transactions',
			'db_username'=>'usergwdodb',
			'db_password'=>'hiSS1qLBKocwQKS9aIQjkd',
			'db_database'=>'dbnamegwdo30',
		'db_hostname'=>'172.31.43.128',
			'DbPort'=>'3306',
			'connection_type'=>'MYSQLI',
		'MORE_MASTER'=>[
			1=>array(
