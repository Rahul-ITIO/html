...
if((isset($_REQUEST['check_auth'])&&$_REQUEST['check_auth'])||(isset($_REQUEST['cron_host_response'])&&$_REQUEST['cron_host_response'])||(isset($_REQUEST['webhook_id'])&&$_REQUEST['webhook_id']))
{
	echo "NOT ACCESS VIA CRON";
	exit;
}
