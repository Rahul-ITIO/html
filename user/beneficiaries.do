...
if(isset($_POST['send'])&&$_POST['send']=='submit_data'){
	...
	if(!isset($post['beneficiary_nickname'])||!$post['beneficiary_nickname']){
		...
		$sqlStmt = "INSERT INTO `{$data['DbPrefix']}payout_beneficiary` (`clientid`, `beneficiary_nickname`,`bank_name`, `beneficiary_name`, `account_number`, `bank_code1`, `bank_code2`, `bank_code3`, `beneficiaryEmailId`, `beneficiaryPhone`, `udf1`, `udf2`, `status`, `client_ip`, `host_name`) VALUES ( '".$uid."', '".$post['beneficiary_nickname']."','".$post['bank_name']."', '".$post['beneficiary_name']."', '".$post['account_number']."', '".$post['bank_code1']."', '".$post['bank_code2']."', '".$post['bank_code3']."', '".$post['beneficiaryEmailId']."', '".$post['beneficiaryPhone']."', '".$post['udf1']."', '".$post['udf2']."', 1, '{$client_ip}', '".$_SERVER['HTTP_HOST']."')";
