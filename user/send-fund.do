...
$payout_setting_data = select_tablef("`clientid` = '".$uid."'",'payout_setting');
$payout_account	= $post['payout_account'] = $payout_setting_data['payout_account'];
...
//print_r($payout_bank_detail);

/*
$payout_bank_detail	= select_tablef("`id` = '".$payout_account."'",'bank_payout_table');
	$ac_payout_id	= $bank_master['payout_id'];
	$ac_default_curr=$data['payout_default_curr']=$bank_master['payout_processing_currency'];	//fetch Bank Processing default currency
*/
