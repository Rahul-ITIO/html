<?
$data['PageName']	= 'Qr Code Dashboard';
$data['PageFile']	= 'qr_code_dashboard';

###############################################################################
include('../config.do');
$data['PageTitle'] = 'Qr Code Dashboard - '.$data['domain_name']; 
##########################Check Permission#####################################
...
/*if(($data['PageFile']=='summary') && ($_REQUEST['act']=="1")){
