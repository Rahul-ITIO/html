<?php
// http://localhost:8080/gw/tinclude/mf?merID=11319&dtest=2&qp=1
function print_mem()
{
...
$payout_res=fetch_last_withdraw_monthly_fee_wv3_custom($merID,2);
echo "<br/><br/>fetch_last_withdraw_monthly_fee_wv3_custom=>";
print_r($payout_res);
