...
$api_url = "https://testsecureacceptance.cybersource.com/commerce/1.x/transactionProcessor"; // Ensure this is the correct NVP endpoint
...
file_put_contents('request.log', print_r($request_data, true) . PHP_EOL, FILE_APPEND);
